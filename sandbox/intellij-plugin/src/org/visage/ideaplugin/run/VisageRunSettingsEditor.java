 ...
 * @author David Kaspar
 */
public class VisageRunSettingsEditor extends SettingsEditor<VisageRunConfiguration> {

    private final VisageRunSettingsPanel panel;
    private final DefaultComboBoxModel moduleModel;

    public VisageRunSettingsEditor (Project project) {
        panel = new VisageRunSettingsPanel ();
    ...
    protected void resetEditorFrom (VisageRunConfiguration configuration) {
    ...
    protected void applyEditorTo (VisageRunConfiguration configuration) throws ConfigurationException {
