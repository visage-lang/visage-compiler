 ...
 * @author David Kaspar
 */
public final class VisageSdkAdditionalData implements SdkAdditionalData {

    private final String javaSdkName;
    private final SdkModel sdkModel;

    public VisageSdkAdditionalData (String javaSdkName, SdkModel sdkModel) {
    ...
    public VisageSdkAdditionalData clone () throws CloneNotSupportedException {
        return (VisageSdkAdditionalData) super.clone ();
    }
