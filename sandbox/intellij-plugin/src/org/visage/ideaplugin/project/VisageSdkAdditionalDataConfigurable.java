 ...
 * @author David Kaspar
 */
public final class VisageSdkAdditionalDataConfigurable implements AdditionalDataConfigurable {

    private final SdkModel sdkModel;
    private final SdkModel.Listener listener;
    private final DefaultComboBoxModel model;
    private final VisageSdkAdditionalDataPanel panel;
    private Sdk visageSdk;

    public VisageSdkAdditionalDataConfigurable (SdkModel sdkModel) {
        this.sdkModel = sdkModel;

        model = new DefaultComboBoxModel ();

        panel = new VisageSdkAdditionalDataPanel ();
    ...
    public boolean isModified () {
        VisageSdkAdditionalData additionalData = (VisageSdkAdditionalData) visageSdk.getSdkAdditionalData();
    ...
    public void apply () {
        ...
        Sdk selectedSdk = (Sdk) model.getSelectedItem ();
        modificator.setSdkAdditionalData (new VisageSdkAdditionalData (selectedSdk != null ? selectedSdk.getName () : null, sdkModel));
    ...
    public void reset () {
        VisageSdkAdditionalData data = (VisageSdkAdditionalData) visageSdk.getSdkAdditionalData ();
        if (data != null) {
