 ...
 * @author Brian Goetz
 */
public class NewVisageClassAction extends CreateElementActionBase {

    public NewVisageClassAction() {
        super("Visage Class", "Creates Visage Class", VisagePlugin.VISAGE_ICON);
    }
    ...
    protected PsiElement[] create(String newName, PsiDirectory directory) throws Exception {
        ...
        final PsiFile file = psiManager.getElementFactory().createFileFromText(newName + '.' + VisagePlugin.VISAGE_FILE_EXTENSION, "");
