 ...
 * @author Brian Goetz
 */
public class VisageHighlighter extends SyntaxHighlighterBase {
    ...
    static {
        ...
        fillMap(keys, VisageTokens.KEYWORDS, VISAGE_KEYWORD);
        fillMap(keys, VisageTokens.STRING_LITERALS, VISAGE_STRING);
        fillMap(keys, VisageTokens.NUMERIC_LITERALS, VISAGE_NUMERIC);
        keys.put(TokenType.BAD_CHARACTER, VISAGE_BAD_CHARACTER);
        keys.put(VisageTokens.COMMENT.elementType, VISAGE_BLOCK_COMMENT);
        keys.put(VisageTokens.LINE_COMMENT.elementType, VISAGE_LINE_COMMENT);
    }

    @NotNull
    public Lexer getHighlightingLexer() {
        return new VisageLexer();
    }
