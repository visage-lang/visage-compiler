...
public enum FxTokens {
    ...
    public static TokenSet LITERALS = createTokenSet(DECIMAL_LITERAL, STRING_LITERAL, RBRACE_LBRACE_STRING_LITERAL, RBRACE_QUOTE_STRING_LITERAL, QUOTE_LBRACE_STRING_LITERAL);
