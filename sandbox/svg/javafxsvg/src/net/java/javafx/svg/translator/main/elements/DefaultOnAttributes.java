...
public class DefaultOnAttributes implements ElementHandler {
    private static DefaultOnAttributes instance = new DefaultOnAttributes();
    
    public static DefaultOnAttributes getInstance() {
        return instance;
    }
    
    private DefaultOnAttributes() {}
