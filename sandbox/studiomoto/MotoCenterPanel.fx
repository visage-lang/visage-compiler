...
function MotoCenterPanel.composeNode() =
Clip {
    ...
    Group {
        ...
        [ImageView {
            ...
            image: {url: "{__DIR__}/Image/73.png"}
        },
        VBox {
            content:
            [View {
            ...
            Group {
                ...
                [ImageView {
                    ...
                    // 56x35
                    image: {url: "{__DIR__}/Image/74.png"}
                },
                ImageView {
                    visible: bind g.hover
                    image: {url: "{__DIR__}/Image/75.png"}
                },
                Text {
                    transform: translate(56/2, 35/2)
                    valign: MIDDLE, halign: CENTER
                    fill: bind if g.hover then black else white
                    content: "GO"
...
attribute MotoCenterPanel.height = 300;
attribute MotoCenterPanel.width = 500;
Canvas {
    background: brown
    content:
    MotoCenterPanel {
