...
public class ColorConstants {
    public static attribute slate:Paint= LinearGradient{ startX:0, startY:0, endX:0, endY:1, 
    ...
    public static attribute blueGrad:Paint= LinearGradient{ startX:0, startY:0, endX:0, endY:1, 
