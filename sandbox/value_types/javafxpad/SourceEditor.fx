...
public class SourceEditor extends ScrollableWidget {
    ...
    attribute addEditTimeline: Timeline;
    operation maybeAddEdit();
}

attribute SourceEditor.addEditTimeline = Timeline {
    keyFrames:
    [at (0s) {},
    at (2s) {
        trigger {
            if (edit instanceof CompoundEdit) {
                var compoundEdit = (CompoundEdit)edit;
...
operation SourceEditor.maybeAddEdit() {
    addEditTimeline.start();
}
