...
class ProjectSample {
    ...
    attribute propTabs:Tab[];
    attribute propLocales:List;
...
public class AssortisProject  extends CompositeWidget{
    ...
    attribute treeNode: TreeNode;

    attribute treeCell: TreeCell;
    attribute frames: InternalFrame[];
    attribute samples:ProjectSample[];
    attribute executedSamples:ProjectSample[];

    attribute codeTabs:Tab[];

    attribute selectedCodeIndex: Number on replace{
    ...
    attribute currentPropTabs:Tab[];
    attribute currentPropLocales:List;
    attribute defLocale:Locale = Locale.getDefault();

    attribute selectedPropIndex: Number on replace {
    ...
    attribute selectedSampleIndex: Integer;


    attribute selectedModule:Object on replace{
    ...
    attribute keyTimers:KeyTimer[];
    attribute KEY_TIMEOUT = 600.0;
    attribute KEY_PROCESS_TIMEOUT = 400;

    attribute DEFAULT_FRAME_WIDTH  = 300.0;
    attribute DEFAULT_FRAME_HEIGHT = 200.0;
