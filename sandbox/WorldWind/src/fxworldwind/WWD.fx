...
public class WWD extends Widget {
    public attribute wwd: WorldWindowGLJPanel = new WorldWindowGLJPanel() on replace {
        ...
        var clazz = java.lang.Thread.currentThread().getContextClassLoader().loadClass("gov.nasa.worldwind.layers.Earth.WorldMapLayer");
        this.wwd.addSelectListener(new ClickAndGoSelectListener(this.wwd, clazz));
