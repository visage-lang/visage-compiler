 ...
 * @profile common
 */        
public def TRANSPARENT          = color(0.0, 0.0, 0.0, 0.0);

public def ALICEBLUE            = rgb(0xF0, 0xF8, 0xFF);
public def ANTIQUEWHITE         = rgb(0xFA, 0xEB, 0xD7);
public def AQUA                 = rgb(0x00, 0xFF, 0xFF);
public def AQUAMARINE           = rgb(0x7F, 0xFF, 0xD4);
public def AZURE                = rgb(0xF0, 0xFF, 0xFF);
public def BEIGE                = rgb(0xF5, 0xF5, 0xDC);
public def BISQUE               = rgb(0xFF, 0xE4, 0xC4);
public def BLACK                = rgb(0x00, 0x00, 0x00);
public def BLANCHEDALMOND       = rgb(0xFF, 0xEB, 0xCD);
public def BLUE                 = rgb(0x00, 0x00, 0xFF);
public def BLUEVIOLET           = rgb(0x8A, 0x2B, 0xE2);
public def BROWN                = rgb(0xA5, 0x2A, 0x2A);
public def BURLYWOOD            = rgb(0xDE, 0xB8, 0x87);
public def CADETBLUE            = rgb(0x5F, 0x9E, 0xA0);
public def CHARTREUSE           = rgb(0x7F, 0xFF, 0x00);
public def CHOCOLATE            = rgb(0xD2, 0x69, 0x1E);
public def CORAL                = rgb(0xFF, 0x7F, 0x50);
public def CORNFLOWERBLUE       = rgb(0x64, 0x95, 0xED);
public def CORNSILK             = rgb(0xFF, 0xF8, 0xDC);
public def CRIMSON              = rgb(0xDC, 0x14, 0x3C);
public def CYAN                 = rgb(0x00, 0xFF, 0xFF);
public def DARKBLUE             = rgb(0x00, 0x00, 0x8B);
public def DARKCYAN             = rgb(0x00, 0x8B, 0x8B);
public def DARKGOLDENROD        = rgb(0xB8, 0x86, 0x0B);
public def DARKGRAY             = rgb(0xA9, 0xA9, 0xA9);
public def DARKGREEN            = rgb(0x00, 0x64, 0x00);
public def DARKGREY             = DARKGRAY;
public def DARKKHAKI            = rgb(0xBD, 0xB7, 0x6B);
public def DARKMAGENTA          = rgb(0x8B, 0x00, 0x8B);
public def DARKOLIVEGREEN       = rgb(0x55, 0x6B, 0x2F);
public def DARKORANGE           = rgb(0xFF, 0x8C, 0x00);
public def DARKORCHID           = rgb(0x99, 0x32, 0xCC);
public def DARKRED              = rgb(0x8B, 0x00, 0x00);
public def DARKSALMON           = rgb(0xE9, 0x96, 0x7A);
public def DARKSEAGREEN         = rgb(0x8F, 0xBC, 0x8F);
public def DARKSLATEBLUE        = rgb(0x48, 0x3D, 0x8B);
public def DARKSLATEGRAY        = rgb(0x2F, 0x4F, 0x4F);
public def DARKSLATEGREY        = DARKSLATEGRAY;
public def DARKTURQUOISE        = rgb(0x00, 0xCE, 0xD1);
public def DARKVIOLET           = rgb(0x94, 0x00, 0xD3);
public def DEEPPINK             = rgb(0xFF, 0x14, 0x93);
public def DEEPSKYBLUE          = rgb(0x00, 0xBF, 0xFF);
public def DIMGRAY              = rgb(0x69, 0x69, 0x69);
public def DIMGREY              = DIMGRAY;
public def DODGERBLUE           = rgb(0x1E, 0x90, 0xFF);
public def FIREBRICK            = rgb(0xB2, 0x22, 0x22);
public def FLORALWHITE          = rgb(0xFF, 0xFA, 0xF0);
public def FORESTGREEN          = rgb(0x22, 0x8B, 0x22);
public def FUCHSIA              = rgb(0xFF, 0x00, 0xFF);
public def GAINSBORO            = rgb(0xDC, 0xDC, 0xDC);
public def GHOSTWHITE           = rgb(0xF8, 0xF8, 0xFF);
public def GOLD                 = rgb(0xFF, 0xD7, 0x00);
public def GOLDENROD            = rgb(0xDA, 0xA5, 0x20);
public def GRAY                 = rgb(0x80, 0x80, 0x80);
public def GREEN                = rgb(0x00, 0x80, 0x00);
public def GREENYELLOW          = rgb(0xAD, 0xFF, 0x2F);
public def GREY                 = GRAY;
public def HONEYDEW             = rgb(0xF0, 0xFF, 0xF0);
public def HOTPINK              = rgb(0xFF, 0x69, 0xB4);
public def INDIANRED            = rgb(0xCD, 0x5C, 0x5C);
public def INDIGO               = rgb(0x4B, 0x00, 0x82);
public def IVORY                = rgb(0xFF, 0xFF, 0xF0);
public def KHAKI                = rgb(0xF0, 0xE6, 0x8C);
public def LAVENDER             = rgb(0xE6, 0xE6, 0xFA);
public def LAVENDERBLUSH        = rgb(0xFF, 0xF0, 0xF5);
public def LAWNGREEN            = rgb(0x7C, 0xFC, 0x00);
public def LEMONCHIFFON         = rgb(0xFF, 0xFA, 0xCD);
public def LIGHTBLUE            = rgb(0xAD, 0xD8, 0xE6);
public def LIGHTCORAL           = rgb(0xF0, 0x80, 0x80);
public def LIGHTCYAN            = rgb(0xE0, 0xFF, 0xFF);
public def LIGHTGOLDENRODYELLOW = rgb(0xFA, 0xFA, 0xD2);
public def LIGHTGRAY            = rgb(0xD3, 0xD3, 0xD3);
public def LIGHTGREEN           = rgb(0x90, 0xEE, 0x90);
public def LIGHTGREY            = LIGHTGRAY;
public def LIGHTPINK            = rgb(0xFF, 0xB6, 0xC1);
public def LIGHTSALMON          = rgb(0xFF, 0xA0, 0x7A);
public def LIGHTSEAGREEN        = rgb(0x20, 0xB2, 0xAA);
public def LIGHTSKYBLUE         = rgb(0x87, 0xCE, 0xFA);
public def LIGHTSLATEGRAY       = rgb(0x77, 0x88, 0x99);
public def LIGHTSLATEGREY       = LIGHTSLATEGRAY;
public def LIGHTSTEELBLUE       = rgb(0xB0, 0xC4, 0xDE);
public def LIGHTYELLOW          = rgb(0xFF, 0xFF, 0xE0);
public def LIME                 = rgb(0x00, 0xFF, 0x00);
public def LIMEGREEN            = rgb(0x32, 0xCD, 0x32);
public def LINEN                = rgb(0xFA, 0xF0, 0xE6);
public def MAGENTA              = rgb(0xFF, 0x00, 0xFF);
public def MAROON               = rgb(0x80, 0x00, 0x00);
public def MEDIUMAQUAMARINE     = rgb(0x66, 0xCD, 0xAA);
public def MEDIUMBLUE           = rgb(0x00, 0x00, 0xCD);
public def MEDIUMORCHID         = rgb(0xBA, 0x55, 0xD3);
public def MEDIUMPURPLE         = rgb(0x93, 0x70, 0xDB);
public def MEDIUMSEAGREEN       = rgb(0x3C, 0xB3, 0x71);
public def MEDIUMSLATEBLUE      = rgb(0x7B, 0x68, 0xEE);
public def MEDIUMSPRINGGREEN    = rgb(0x00, 0xFA, 0x9A);
public def MEDIUMTURQUOISE      = rgb(0x48, 0xD1, 0xCC);
public def MEDIUMVIOLETRED      = rgb(0xC7, 0x15, 0x85);
public def MIDNIGHTBLUE         = rgb(0x19, 0x19, 0x70);
public def MINTCREAM            = rgb(0xF5, 0xFF, 0xFA);
public def MISTYROSE            = rgb(0xFF, 0xE4, 0xE1);
public def MOCCASIN             = rgb(0xFF, 0xE4, 0xB5);
public def NAVAJOWHITE          = rgb(0xFF, 0xDE, 0xAD);
public def NAVY                 = rgb(0x00, 0x00, 0x80);
public def OLDLACE              = rgb(0xFD, 0xF5, 0xE6);
public def OLIVE                = rgb(0x80, 0x80, 0x00);
public def OLIVEDRAB            = rgb(0x6B, 0x8E, 0x23);
public def ORANGE               = rgb(0xFF, 0xA5, 0x00);
public def ORANGERED            = rgb(0xFF, 0x45, 0x00);
public def ORCHID               = rgb(0xDA, 0x70, 0xD6);
public def PALEGOLDENROD        = rgb(0xEE, 0xE8, 0xAA);
public def PALEGREEN            = rgb(0x98, 0xFB, 0x98);
public def PALETURQUOISE        = rgb(0xAF, 0xEE, 0xEE);
public def PALEVIOLETRED        = rgb(0xDB, 0x70, 0x93);
public def PAPAYAWHIP           = rgb(0xFF, 0xEF, 0xD5);
public def PEACHPUFF            = rgb(0xFF, 0xDA, 0xB9);
public def PERU                 = rgb(0xCD, 0x85, 0x3F);
public def PINK                 = rgb(0xFF, 0xC0, 0xCB);
public def PLUM                 = rgb(0xDD, 0xA0, 0xDD);
public def POWDERBLUE           = rgb(0xB0, 0xE0, 0xE6);
public def PURPLE               = rgb(0x80, 0x00, 0x80);
public def RED                  = rgb(0xFF, 0x00, 0x00);
public def ROSYBROWN            = rgb(0xBC, 0x8F, 0x8F);
public def ROYALBLUE            = rgb(0x41, 0x69, 0xE1);
public def SADDLEBROWN          = rgb(0x8B, 0x45, 0x13);
public def SALMON               = rgb(0xFA, 0x80, 0x72);
public def SANDYBROWN           = rgb(0xF4, 0xA4, 0x60);
public def SEAGREEN             = rgb(0x2E, 0x8B, 0x57);
public def SEASHELL             = rgb(0xFF, 0xF5, 0xEE);
public def SIENNA               = rgb(0xA0, 0x52, 0x2D);
public def SILVER               = rgb(0xC0, 0xC0, 0xC0);
public def SKYBLUE              = rgb(0x87, 0xCE, 0xEB);
public def SLATEBLUE            = rgb(0x6A, 0x5A, 0xCD);
public def SLATEGRAY            = rgb(0x70, 0x80, 0x90);
public def SLATEGREY            = SLATEGRAY;
public def SNOW                 = rgb(0xFF, 0xFA, 0xFA);
public def SPRINGGREEN          = rgb(0x00, 0xFF, 0x7F);
public def STEELBLUE            = rgb(0x46, 0x82, 0xB4);
public def TAN                  = rgb(0xD2, 0xB4, 0x8C);
public def TEAL                 = rgb(0x00, 0x80, 0x80);
public def THISTLE              = rgb(0xD8, 0xBF, 0xD8);
public def TOMATO               = rgb(0xFF, 0x63, 0x47);
public def TURQUOISE            = rgb(0x40, 0xE0, 0xD0);
public def VIOLET               = rgb(0xEE, 0x82, 0xEE);
public def WHEAT                = rgb(0xF5, 0xDE, 0xB3);
public def WHITE                = rgb(0xFF, 0xFF, 0xFF);
public def WHITESMOKE           = rgb(0xF5, 0xF5, 0xF5);
public def YELLOW               = rgb(0xFF, 0xFF, 0x00);
public def YELLOWGREEN          = rgb(0x9A, 0xCD, 0x32);
