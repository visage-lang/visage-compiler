...
public abstract class Shape extends Node, Interpolatable {
     ...
     */
    public function impl_getSGAbstractShape():SGAbstractShape { 
        impl_getSGNode() as SGAbstractShape 
    }
    ...
    public attribute strokeDashArray:Number[] = null on replace oldS[a..b] = newS { updateStroke(); }
     ...
     private function updateMode():Void {
        ...
        impl_getSGAbstractShape().setMode(mode);
    }
    ...
    */
    public attribute smooth:Boolean = true on replace {
        var node = impl_getSGAbstractShape();
    ...
    public function ofTheWay(endVal:Object, t:Number): Object {
        ...
        var v1 = impl_getSGAbstractShape().getShape();
        var v2 = (endVal as Shape).impl_getSGAbstractShape().getShape();
        var s = DelegateShape {};
