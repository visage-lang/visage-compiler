 ...
 * @profile common
 */
public function affine(m00:Number, m01:Number, m02:Number, m10:Number, m11:Number, m12:Number):Affine {
 ...
 * @profile common
 */
public function rotate(angle:Number, x:Number, y:Number):Rotate {
 ...
 * @profile common
 */
public function scale(x:Number, y:Number):Scale {
    Scale{ x:x y:y }
}
