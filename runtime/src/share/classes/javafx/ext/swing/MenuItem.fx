...
// PENDING_DOC_REVIEW
/**
 * An implementation of an item in a {@link Menu}. A menu item is essentially 
 * a button sitting in a list. When the user selects the "button", the action
...
public class MenuItem extends AbstractButton {
    ...
    // PENDING_DOC_REVIEW
    /**
     * Returns the {@link JMenuItem} delegate for this component.
     */
    public /* final */ function getJMenuItem(): JMenuItem {
        getAbstractButton() as JMenuItem;
    }
