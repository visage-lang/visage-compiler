...
public class TransferHandler implements Serializable {
    ...
    private static class DragHandler implements DragGestureListener, DragSourceListener {
        ...
        public void dragGestureRecognized(DragGestureEvent dge) {
            ...
            TransferHandler th = getTransferHandler(c);
        ...
        public void dragDropEnd(DragSourceDropEvent dsde) {
            ...
            if (dsde.getDropSuccess()) {
                getTransferHandler(c).exportDone(c, dsc.getTransferable(), dsde.getDropAction());
            } else {
                getTransferHandler(c).exportDone(c, dsc.getTransferable(), NONE);
            }
            c.setAutoscrolls(scrolls);
        }
    ...
    public static TransferHandler getTransferHandler(JComponent c) {
        return (TransferHandler)c.getClientProperty("JComponent_TRANSFER_HANDLER");
    }

    public static void setTransferHandler(JComponent c, TransferHandler newHandler) {
        TransferHandler oldHandler = (TransferHandler)c.getClientProperty(
                                      "JComponent_TRANSFER_HANDLER");
        c.putClientProperty("JComponent_TRANSFER_HANDLER", newHandler);
    }
    
    private static class AccessibleMethod {
