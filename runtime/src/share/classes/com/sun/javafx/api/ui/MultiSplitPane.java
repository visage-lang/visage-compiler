/*
 * $Id: MultiSplitPane.java,v 1.2 2006/11/27 22:16:20 coliver Exp $
 *
...
import com.sun.javafx.api.ui.MultiSplitLayout.Divider;
import com.sun.javafx.api.ui.MultiSplitLayout.Node;
...
public class MultiSplitPane extends JPanel {
    // purposely hides accessibleContext in JPanel
    ...
    public void repaint(long tm, int x, int y, int w, int h) {
        ...
        System.out.println("msp repaintBounds = "+repaintBounds);
        bounds = bounds.intersection(repaintBounds);
        System.out.println("msp bounds="+bounds);
