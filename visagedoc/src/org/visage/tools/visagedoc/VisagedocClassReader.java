 ...
 * The "visage-level" class reader is a VisageClassReader that <i>delegates</i>
 * to a VisagedocClassReader.  This may be fragile, given that (unlike visagec)
 * we only have set of Symbols and Types, but it seems to work - for now.
 */
class VisagedocClassReader extends ClassReader {
    ...
    public VisagedocClassReader(Context context) {
        super(context, false);
