...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="target-class">visage.ui.ToggleButton</xsl:param>
    ...
    <xsl:template name="add-copyright-link">
        ...
        <i>Use is subject to <a href="http://java.sun.com/visage/1.3/docs/api/license.html">license terms</a>.</i><br/>
    </xsl:template>
...
<!-- ====================== -->    
    ...
    <xsl:template match="class[@language='visage']" mode="interface">
