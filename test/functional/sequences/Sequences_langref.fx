...
//1 == [1]; // returns true
//check( (1==[1]),"compare int with single value sequence");   // jfxc-833 - this return false.
...
/*
jfxc-834: In the section on Sequnces there are two samples showing usage of the"shorthand notation" for declaring a sequence:
