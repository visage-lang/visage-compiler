...
// bug jfxc-2567 - comiler won't allow number smaller than min int on right side of assignment
//def MINLONG:Long = -9223372036854775807-1;
//if( findMaxLong() != MAXLONG   ) throw new Exception("error in findMaxLong");

// bug jfxc-2543 - comparison operator does not accpet min Long value
