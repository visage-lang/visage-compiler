...
protected class A {
public readable attribute a = 32;
...
class C extends B {
// readable is now enforced, commented out since it causes code below to not compile
 /*readable*/ attribute y = 34;
 attribute y2 = 35;
...
abstract class inner {
	readable attribute innerthis;
	abstract function getThis():String 
 }
abstract class localclass {
	readable attribute localthis;
	abstract function getThis():String 
}

class outer {
 readable attribute outterthis = this;
