...
//System.out.println("\n<Interpolator.SPLINE(0.2,0.8, 0.7,0.3)>");
keyValue.interpolate = Interpolator.SPLINE(0.2,0.8, 0.7,0.3);
t.start();
...
function check() {
	...
	if(avgBegin > 3.7 or avgBegin < 1.7) {
...
var mySpline: Interpolator = Interpolator.SPLINE(0.2,0.8, 0.7,0.3);
