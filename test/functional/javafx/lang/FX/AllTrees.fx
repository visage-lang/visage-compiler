/*
 * Copied from test/src/com/sun/tools/javafx/api/AllTrees.fx so that it can be run by
 * FXCompilerTest and used in smoketest.
 *
 * @test
 * @run
 */
...
// COMPILATION_UNIT
// package not allowed in an FXCompilerTest.
//package testfx;
