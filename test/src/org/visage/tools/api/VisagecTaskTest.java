...
/**
 * Unit test for VisagecTask interface and its VisagecTaskImpl implementation.
 */
public class VisagecTaskTest {
    ...
    public void parseNullSourceList() throws Exception {
        VisagecTool instance = new VisagecTool();
        VisagecTask task = instance.getTask(null, null, null, null, null);
        Iterable<? extends UnitTree> result = task.parse();
