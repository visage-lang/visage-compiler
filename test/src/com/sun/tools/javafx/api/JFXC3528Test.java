...
public class JFXC3528Test {
    ...
    public void testPreserveParens() throws Exception {
        ...
        try {
            ...
            File file = new File("test/src/com/sun/tools/javafx/api/JFXC3528.fx");
            Iterable<? extends JavaFileObject> fileObjects = fileManager.getJavaFileObjects(file);
            JavafxcTask javafxTask = tool.getTask(null, fileManager, dl, List.<String>of("-XDpreserveTrees"), fileObjects);
