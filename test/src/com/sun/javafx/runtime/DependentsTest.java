...
public class DependentsTest extends JavaFXTestCase {
    ...
    public void testUpdate() {
        ...
        // update zeroth var
        src.notifyDependents$(0, FXObject.VFLGS$INVAL_PHASE);
        ...
        // update first var
        src.notifyDependents$(1, FXObject.VFLGS$INVAL_PHASE);
    ...
    public void testSwitchDependence() {
        ...
        src1.notifyDependents$(0, FXObject.VFLGS$INVAL_PHASE);
        ...
        src2.notifyDependents$(0, FXObject.VFLGS$INVAL_PHASE);
