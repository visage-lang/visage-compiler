/*
 * Lazy binding for if statement, global variables
 *
 * @test
 * @run
 */
...
def bindedByte3 : Byte = bind lazy
        if(bindedByte4 != 120) then fByte(122) else fByte(120);
...
def bindedBByte3 : Byte = bind
        if(bindedBByte4 != 120) then fByte(122) else fByte(120);
...
def bindedShort3 : Short = bind lazy
        if(bindedShort4 != 30000) then fShort(30002) else fShort(30000);
...
def bindedBShort3 : Short = bind
        if(bindedBShort4 != 30000) then fShort(30002) else fShort(30000);
...
def bindedCharacter3 : Character = bind lazy
        if(bindedCharacter4 != 64) then fCharacter(62) else fCharacter(64);
...
def bindedBCharacter3 : Character = bind
        if(bindedBCharacter4 != 64) then fCharacter(62) else fCharacter(64);
...
def bindedInteger3 : Integer = bind lazy
        if(bindedInteger4 != 1000000) then fInteger(1000002) else fInteger(1000000);
...
def bindedBInteger3 : Integer = bind
        if(bindedBInteger4 != 1000000) then fInteger(1000002) else fInteger(1000000);
...
def bindedLong3 : Long = bind lazy
        if(bindedLong4 != 1000000000) then fLong(1000000002) else fLong(1000000000);
...
def bindedBLong3 : Long = bind
        if(bindedBLong4 != 1000000000) then fLong(1000000002) else fLong(1000000000);
...
def bindedFloat3 : Float = bind lazy
        if(bindedFloat4 != 10.5) then fFloat(12.5) else fFloat(10.5);
...
def bindedBFloat3 : Float = bind
        if(bindedBFloat4 != 10.5) then fFloat(12.5) else fFloat(10.5);
...
def bindedDouble3 : Double = bind lazy
        if(bindedDouble4 != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
...
def bindedBDouble3 : Double = bind
        if(bindedBDouble4 != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
...
def bindedNumber3 : Number = bind lazy
        if(bindedNumber4 != 100) then fNumber(102) else fNumber(100);
...
def bindedBNumber3 : Number = bind
        if(bindedBNumber4 != 100) then fNumber(102) else fNumber(100);
...
def bindedString3 : String = bind lazy
        if(bindedString4 != "-50") then fString("-52") else fString("-50");
...
def bindedBString3 : String = bind
        if(bindedBString4 != "-50") then fString("-52") else fString("-50");
...
def bindedBoolean3 : Boolean = bind lazy
        if(bindedBoolean4 != true) then fBoolean(true) else fBoolean(true);
...
def bindedBBoolean3 : Boolean = bind
        if(bindedBBoolean4 != true) then fBoolean(true) else fBoolean(true);
...
def bindedDuration3 : Duration = bind lazy
        if(bindedDuration4 != 10s) then fDuration(12s) else fDuration(10s);
...
def bindedBDuration3 : Duration = bind
        if(bindedBDuration4 != 10s) then fDuration(12s) else fDuration(10s);
...
function testGlobalFunc() {
    ...
    def bindedFuncByte3 : Byte = bind lazy
            if(bindedFuncByte4 != 120) then fByte(122) else fByte(120);
    ...
    def bindedFuncBByte3 : Byte = bind
            if(bindedFuncBByte4 != 120) then fByte(122) else fByte(120);
    ...
    def bindedFuncShort3 : Short = bind lazy
            if(bindedFuncShort4 != 30000) then fShort(30002) else fShort(30000);
    ...
    def bindedFuncBShort3 : Short = bind
            if(bindedFuncBShort4 != 30000) then fShort(30002) else fShort(30000);
...
/*
    ...
    def bindedFuncCharacter3 : Character = bind lazy
            if(bindedFuncCharacter4 != 64) then fCharacter(62) else fCharacter(64);
    ...
    def bindedFuncBCharacter3 : Character = bind
            if(bindedFuncBCharacter4 != 64) then fCharacter(62) else fCharacter(64);
...
*/
    ...
    def bindedFuncInteger3 : Integer = bind lazy
            if(bindedFuncInteger4 != 1000000) then fInteger(1000002) else fInteger(1000000);
    ...
    def bindedFuncBInteger3 : Integer = bind
            if(bindedFuncBInteger4 != 1000000) then fInteger(1000002) else fInteger(1000000);
    ...
    def bindedFuncLong3 : Long = bind lazy
            if(bindedFuncLong4 != 1000000000) then fLong(1000000002) else fLong(1000000000);
    ...
    def bindedFuncBLong3 : Long = bind
            if(bindedFuncBLong4 != 1000000000) then fLong(1000000002) else fLong(1000000000);
    ...
    def bindedFuncFloat3 : Float = bind lazy
            if(bindedFuncFloat4 != 10.5) then fFloat(12.5) else fFloat(10.5);
    ...
    def bindedFuncBFloat3 : Float = bind
            if(bindedFuncBFloat4 != 10.5) then fFloat(12.5) else fFloat(10.5);
    ...
    def bindedFuncDouble3 : Double = bind lazy
            if(bindedFuncDouble4 != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
    ...
    def bindedFuncBDouble3 : Double = bind
            if(bindedFuncBDouble4 != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
    ...
    def bindedFuncNumber3 : Number = bind lazy
            if(bindedFuncNumber4 != 100) then fNumber(102) else fNumber(100);
    ...
    def bindedFuncBNumber3 : Number = bind
            if(bindedFuncBNumber4 != 100) then fNumber(102) else fNumber(100);
    ...
    def bindedFuncString3 : String = bind lazy
            if(bindedFuncString4 != "-50") then fString("-52") else fString("-50");
    ...
    def bindedFuncBString3 : String = bind
            if(bindedFuncBString4 != "-50") then fString("-52") else fString("-50");
    ...
    def bindedFuncBoolean3 : Boolean = bind lazy
            if(bindedFuncBoolean4 != true) then fBoolean(true) else fBoolean(true);
    ...
    def bindedFuncBBoolean3 : Boolean = bind
            if(bindedFuncBBoolean4 != true) then fBoolean(true) else fBoolean(true);
    ...
    def bindedFuncDuration3 : Duration = bind lazy
            if(bindedFuncDuration4 != 10s) then fDuration(12s) else fDuration(10s);
    ...
    def bindedFuncBDuration3 : Duration = bind
            if(bindedFuncBDuration4 != 10s) then fDuration(12s) else fDuration(10s);
