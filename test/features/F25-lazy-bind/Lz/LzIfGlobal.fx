/*
 * Lazy binding for if statement, global and local variables
 *
 * @test
 * @run
 */

// Please update the test (expected value) when issue 3141 will be fixed
// Please uncomment Character when issue 3139 will be fixed
...
def bindedByte3 : Byte = bind lazy
        if(fByte(bindedByte4) != 120) then fByte(122) else fByte(120);
...
def bindedBByte3 : Byte = bind
        if(fByte(bindedBByte4) != 120) then fByte(122) else fByte(120);
...
def bindedShort3 : Short = bind lazy
        if(fShort(bindedShort4) != 30000) then fShort(30002) else fShort(30000);
...
def bindedBShort3 : Short = bind
        if(fShort(bindedBShort4) != 30000) then fShort(30002) else fShort(30000);
...
def bindedCharacter3 : Character = bind lazy
        if(fCharacter(bindedCharacter4) != 64) then fCharacter(62) else fCharacter(64);
...
def bindedBCharacter3 : Character = bind
        if(fCharacter(bindedBCharacter4) != 64) then fCharacter(62) else fCharacter(64);
...
def bindedInteger3 : Integer = bind lazy
        if(fInteger(bindedInteger4) != 1000000) then fInteger(1000002) else fInteger(1000000);
...
def bindedBInteger3 : Integer = bind
        if(fInteger(bindedBInteger4) != 1000000) then fInteger(1000002) else fInteger(1000000);
...
def bindedLong3 : Long = bind lazy
        if(fLong(bindedLong4) != 1000000000) then fLong(1000000002) else fLong(1000000000);
...
def bindedBLong3 : Long = bind
        if(fLong(bindedBLong4) != 1000000000) then fLong(1000000002) else fLong(1000000000);
...
def bindedFloat3 : Float = bind lazy
        if(fFloat(bindedFloat4) != 10.5) then fFloat(12.5) else fFloat(10.5);
...
def bindedBFloat3 : Float = bind
        if(fFloat(bindedBFloat4) != 10.5) then fFloat(12.5) else fFloat(10.5);
...
def bindedDouble3 : Double = bind lazy
        if(fDouble(bindedDouble4) != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
...
def bindedBDouble3 : Double = bind
        if(fDouble(bindedBDouble4) != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
...
def bindedNumber3 : Number = bind lazy
        if(fNumber(bindedNumber4) != 100) then fNumber(102) else fNumber(100);
...
def bindedBNumber3 : Number = bind
        if(fNumber(bindedBNumber4) != 100) then fNumber(102) else fNumber(100);
...
def bindedString3 : String = bind lazy
        if(fString(bindedString4) != "-50") then fString("-52") else fString("-50");
...
def bindedBString3 : String = bind
        if(fString(bindedBString4) != "-50") then fString("-52") else fString("-50");
...
def bindedBoolean3 : Boolean = bind lazy
        if(fBoolean(bindedBoolean4) != true) then fBoolean(true) else fBoolean(true);
...
def bindedBBoolean3 : Boolean = bind
        if(fBoolean(bindedBBoolean4) != true) then fBoolean(true) else fBoolean(true);
...
def bindedDuration3 : Duration = bind lazy
        if(fDuration(bindedDuration4) != 10s) then fDuration(12s) else fDuration(10s);
...
def bindedBDuration3 : Duration = bind
        if(fDuration(bindedBDuration4) != 10s) then fDuration(12s) else fDuration(10s);
...
function testGlobalFunc() {
    ...
    def bindedFuncByte3 : Byte = bind lazy
            if(fByte(bindedFuncByte4) != 120) then fByte(122) else fByte(120);
    ...
    def bindedFuncBByte3 : Byte = bind
            if(fByte(bindedFuncBByte4) != 120) then fByte(122) else fByte(120);
    ...
    def bindedFuncShort3 : Short = bind lazy
            if(fShort(bindedFuncShort4) != 30000) then fShort(30002) else fShort(30000);
    ...
    def bindedFuncBShort3 : Short = bind
            if(fShort(bindedFuncBShort4) != 30000) then fShort(30002) else fShort(30000);
...
/*
    ...
    def bindedFuncCharacter3 : Character = bind lazy
            if(fCharacter(bindedFuncCharacter4) != 64) then fCharacter(62) else fCharacter(64);
    ...
    def bindedFuncBCharacter3 : Character = bind
            if(fCharacter(bindedFuncBCharacter4) != 64) then fCharacter(62) else fCharacter(64);
...
*/
    ...
    def bindedFuncInteger3 : Integer = bind lazy
            if(fInteger(bindedFuncInteger4) != 1000000) then fInteger(1000002) else fInteger(1000000);
    ...
    def bindedFuncBInteger3 : Integer = bind
            if(fInteger(bindedFuncBInteger4) != 1000000) then fInteger(1000002) else fInteger(1000000);
    ...
    def bindedFuncLong3 : Long = bind lazy
            if(fLong(bindedFuncLong4) != 1000000000) then fLong(1000000002) else fLong(1000000000);
    ...
    def bindedFuncBLong3 : Long = bind
            if(fLong(bindedFuncBLong4) != 1000000000) then fLong(1000000002) else fLong(1000000000);
    ...
    def bindedFuncFloat3 : Float = bind lazy
            if(fFloat(bindedFuncFloat4) != 10.5) then fFloat(12.5) else fFloat(10.5);
    ...
    def bindedFuncBFloat3 : Float = bind
            if(fFloat(bindedFuncBFloat4) != 10.5) then fFloat(12.5) else fFloat(10.5);
    ...
    def bindedFuncDouble3 : Double = bind lazy
            if(fDouble(bindedFuncDouble4) != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
    ...
    def bindedFuncBDouble3 : Double = bind
            if(fDouble(bindedFuncBDouble4) != 1.25e4) then fDouble(1.22e4) else fDouble(1.25e4);
    ...
    def bindedFuncNumber3 : Number = bind lazy
            if(fNumber(bindedFuncNumber4) != 100) then fNumber(102) else fNumber(100);
    ...
    def bindedFuncBNumber3 : Number = bind
            if(fNumber(bindedFuncBNumber4) != 100) then fNumber(102) else fNumber(100);
    ...
    def bindedFuncString3 : String = bind lazy
            if(fString(bindedFuncString4) != "-50") then fString("-52") else fString("-50");
    ...
    def bindedFuncBString3 : String = bind
            if(fString(bindedFuncBString4) != "-50") then fString("-52") else fString("-50");
    ...
    def bindedFuncBoolean3 : Boolean = bind lazy
            if(fBoolean(bindedFuncBoolean4) != true) then fBoolean(true) else fBoolean(true);
    ...
    def bindedFuncBBoolean3 : Boolean = bind
            if(fBoolean(bindedFuncBBoolean4) != true) then fBoolean(true) else fBoolean(true);
    ...
    def bindedFuncDuration3 : Duration = bind lazy
            if(fDuration(bindedFuncDuration4) != 10s) then fDuration(12s) else fDuration(10s);
    ...
    def bindedFuncBDuration3 : Duration = bind
            if(fDuration(bindedFuncBDuration4) != 10s) then fDuration(12s) else fDuration(10s);
