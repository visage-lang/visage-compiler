...
/* This currently results in an interesting error message.
  ...
  NoStringNulls.fx:24: reference to add is ambiguous, both method add(T) in com.sun.javafx.runtime.sequence.SequenceBuilder<java.lang.String>
  and method add(com.sun.javafx.runtime.sequence.Sequence<? extends T>) in com.sun.javafx.runtime.sequence.SequenceBuilder<java.lang.String>
