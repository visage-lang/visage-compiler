...
function m(pw : PrintWriter, x : Number[]) : Number[]  { pw.print(CALC); pw.print(x); x }
function n(pw : PrintWriter, x : Number) : Number  { pw.print(CALC); pw.print(x); x }

function check(log : String, upd : Number[], seeResult : Boolean, seq : Number[]) : Void {
