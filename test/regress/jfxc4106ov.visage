 ...
 *
 * Override / bound sequences / on-replace
 *
 * NOTE: on-replace override without initializer are delayed, and the EXPECTED file is thus not quite correct, see JFXC-4119
 *
 * @test
 * @run
 */
