...
package com.sun.javafx.gui.gradients;
...
class GradientPaintContext implements PaintContext {
	...
	if (rast == null || rast.getWidth() < w || rast.getHeight() < h) {
        ...
        SinglePixelPackedSampleModel sppsm =
            (SinglePixelPackedSampleModel) rast.getSampleModel();
        DataBufferInt dbi = (DataBufferInt) rast.getDataBuffer();
        int sampx = rast.getMinX() - rast.getSampleModelTranslateX();
        int sampy = rast.getMinY() - rast.getSampleModelTranslateY();
	int off = dbi.getOffset() + sppsm.getOffset(sampx, sampy);
	int adjust = sppsm.getScanlineStride() - w;
