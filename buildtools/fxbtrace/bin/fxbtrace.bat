...
%JAVAFX_HOME%/bin/javafx -J-javaagent:%BTRACE_HOME%/build/btrace-agent.jar=dumpClasses=false,debug=false,unsafe=false,probeDescPath=.,noServer=true,script=%1 %2 %3 %4 %5 %6 %7 %8 %9
goto end
