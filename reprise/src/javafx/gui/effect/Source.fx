 ...
 * or untransformed (original) image of the content {@code Node} to which
 * this {@code Effect} tree is attached.
 */
public class Source extends Effect {
    private attribute source: com.sun.scenario.effect.Effect;
    ...
    /**
     * Defines whether the transformed (device space) content or
     * untransformed (local node space) content is used.
     */
