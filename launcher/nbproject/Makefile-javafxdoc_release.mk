...
# Object Directory
OBJECTDIR=build/javafxdoc_release/Cygwin-Windows
...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Release/javafxdoc.exe
...
${OBJECTDIR}/src/configuration.o: src/configuration.cpp 
	...
	$(COMPILE.cc) -O2 -DPROJECT_JAVAFXDOC -o ${OBJECTDIR}/src/configuration.o src/configuration.cpp
...
${OBJECTDIR}/src/javafxdoc.o: src/javafxdoc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -O2 -DPROJECT_JAVAFXDOC -o ${OBJECTDIR}/src/javafxdoc.o src/javafxdoc.cpp

${OBJECTDIR}/src/javafx.o: src/javafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -O2 -DPROJECT_JAVAFXDOC -o ${OBJECTDIR}/src/javafx.o src/javafx.cpp
