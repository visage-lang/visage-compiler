...
:jvmoptsDone
set _CLASSPATH=%_JAVAFX_LIBS%\Reprise.jar;%_JAVAFX_LIBS%\javafxrt.jar;%_JAVAFX_LIBS%\@SCENEGRAPH_JAR@;%_JAVAFX_LIBS%\Decora-HW.jar;%_JAVAFX_LIBS%\Decora-D3D.jar;%_CP_%
set _CP_=
set _VAL=
set _CMP=
