...
public class Function6<R, A1, A2, A3, A4, A5, A6> extends Function<R> {
    ...
    public Function6(final VisageObject implementor, final int number) {
    ...
    public Object invoke$(Object arg1, Object arg2, Object[] rargs) {
        if (implementor != null) {
            ...
            return invoke((A1)arg1, (A2)arg2, (A3)rargs[0], (A4)rargs[1], (A5)rargs[2], (A6)rargs[3]);
        }
    }
    
    // Override this
    public R invoke(A1 x1, A2 x2, A3 x3, A4 x4, A5 x5, A6 x6) {
        if (implementor != null) {
            return (R) implementor.invoke$(number, x1, x2, new Object[] { x3, x4, x5, x6 });
        } else {
