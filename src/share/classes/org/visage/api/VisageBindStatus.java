...
public enum VisageBindStatus {
    ...
    /** Creates a new instance of VisageBindStatus */
    private VisageBindStatus(String description, boolean isUnidiBind, boolean isBidiBind) {
