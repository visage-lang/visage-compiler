 ...
 */
public final class VisageTaskEvent
{
    private TaskEvent javacEvent;
    private UnitTree unit;
    private TypeElement clazz;

    public VisageTaskEvent(Kind kind, JavaFileObject sourceFile) {
        this.javacEvent = new TaskEvent(kind, sourceFile);
        this.unit = null;
    }

    public VisageTaskEvent(Kind kind, CompilationUnitTree javaUnit, TypeElement clazz) {
        this.javacEvent = new TaskEvent(kind, javaUnit, clazz);
        this.unit = null;
    }

    public VisageTaskEvent(Kind kind, UnitTree unit) {
        this(kind, unit, null);
    }

    public VisageTaskEvent(Kind kind, UnitTree unit, TypeElement clazz) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VisageTaskEvent[");
        sb.append(getKind());
        sb.append(',');
