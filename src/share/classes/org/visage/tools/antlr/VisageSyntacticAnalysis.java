 ...
 * @author Jim Idle
 */
public class VisageSyntacticAnalysis {

    /** The context key for the parser. */
    protected static final Context.Key<VisageSyntacticAnalysis> syntaxKey =
            new Context.Key<VisageSyntacticAnalysis>();
    ...
    public static VisageSyntacticAnalysis instance(Context context) {
        VisageSyntacticAnalysis instance = context.get(syntaxKey);
        if (instance == null)
            instance = new VisageSyntacticAnalysis(context);
        return instance;
    }
    
    protected VisageSyntacticAnalysis(final Context context) {
