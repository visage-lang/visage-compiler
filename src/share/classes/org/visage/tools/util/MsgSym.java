...
public class MsgSym {
    public static final String MESSAGE_VISAGE_MSG_BUG = "visage.msg.bug";
    public static final String MESSAGE_VISAGE_NOTE_INTERNAL_ERROR = "visage.internal.error";
    public static final String MESSAGE_VISAGE_NOTE_INTERNAL_ERROR1 = "visage.internal.error1";
    public static final String MESSAGE_VISAGE_NOTE_INTERNAL_ERROR2 = "visage.internal.error2";
    public static final String MESSAGE_VISAGE_OPT_ARG_NAME = "visage.opt.arg.name"; 
    public static final String MESSAGE_VISAGE_OPT_PLATFORM = "visage.opt.platform"; 
    ...
    public static final String MESSAGE_VISAGE_KINDNAME_FUNCTION = "kindname.function";

    
    // visage-compiler messages
    public static final String MESSAGE_VISAGE_GENERALERROR = "visage.generalerror"; 
    public static final String MESSAGE_VISAGE_GENERALWARNING = "visage.generalwarning";
    public static final String MESSAGE_VISAGE_RANGE_START_INT_OR_NUMBER = "visage.range.start.int.or.number"; 
    public static final String MESSAGE_VISAGE_RANGE_END_INT_OR_NUMBER = "visage.range.end.int.or.number"; 
    public static final String MESSAGE_VISAGE_RANGE_STEP_INT_OR_NUMBER = "visage.range.step.int.or.number"; 
    public static final String MESSAGE_VISAGE_RANGE_LITERAL_EMPTY = "visage.range.literal.empty"; 
    public static final String MESSAGE_VISAGE_RESERVED_TOP_LEVEL_SCRIPT_MEMBER = "visage.reserved.top.level.script.member";
    public static final String MESSAGE_VISAGE_LOOSE_EXPRESSIONS = "visage.loose.expressions";
    public static final String MESSAGE_VISAGE_RUN_FUNCTION_SINGLE = "visage.run.function.single";
    public static final String MESSAGE_VISAGE_RUN_FUNCTION_PARAM = "visage.run.function.param";
    public static final String MESSAGE_VISAGE_INDEXOF_NOT_FOUND = "visage.indexof.not.found";
    public static final String MESSAGE_VISAGE_KEYFRAME_LIT = "visage.keyframe.literal";
    public static final String MESSAGE_VISAGE_SELF_REFERENCE = "visage.self.ref";
    public static final String MESSAGE_VISAGE_FORWARD_REFERENCE = "visage.forward.ref";
    public static final String MESSAGE_VISAGE_TRY_CATCH = "visage.try.catch";
    public static final String MESSAGE_VISAGE_SEQ_OR_ARRAY = "visage.seq.or.array";
    public static final String MESSAGE_VISAGE_OBJ_OR_SEQ = "visage.obj.or.seq";
    public static final String MESSAGE_VISAGE_LOOSE_IN_LIB = "visage.loose.expr.in.lib";
    public static final String MESSAGE_VISAGE_LOOSE_IN_RUN = "visage.loose.expr.in.run";
    public static final String MESSAGE_VISAGE_CANNOT_INFER_RETURN_TYPE = "visage.cannot.infer.return.type"; 
    public static final String MESSAGE_VISAGE_TYPE_INFER_CYCLE_FUN_DECL = "visage.type.infer.cycle.fun.decl";
    public static final String MESSAGE_VISAGE_TYPE_INFER_CYCLE_VAR_DECL = "visage.type.infer.cycle.var.decl";
    public static final String MESSAGE_VISAGE_TYPE_INFER_CYCLE_VAR_REF = "visage.type.infer.cycle.var.ref";
    public static final String MESSAGE_VISAGE_FUNC_TYPE_INFER_CYCLE = "visage.function.type.infer.cycle";
    public static final String MESSAGE_VISAGE_VOID_SEQUENCE_NOT_ALLOWED = "visage.void.sequence.not.allowed";
    ...
    public static final String MESSAGE_VISAGE_UNSUPPORTED_TYPE_IN_TRIGGER = "visage.unsupported.type.in.trigger";
    public static final String MESSAGE_VISAGE_WRONG_TYPE_FOR_BIDI_BIND = "visage.wrong.type.for.bidi.bind";
    public static final String MESSAGE_VISAGE_BOUND_VAR_IN_BIDI_BIND = "visage.bound.var.in.bidi.bind";
    ...
    public static final String MESSAGE_VISAGE_BOUND_OVERRIDE_METH = "visage.bound.override.meth";
    public static final String MESSAGE_VISAGE_NON_BOUND_OVERRIDE_METH = "visage.non.bound.override.meth";
    public static final String MESSAGE_VISAGE_CANNOT_OVERRIDE_CLASS_VAR_FROM_FUNCTION = "visage.cant.override.var.from.func";
    public static final String MESSAGE_VISAGE_BASE_JAVA_CLASS_NON_PAPAR_CTOR = "visage.base.java.class.non.papar.ctor"; 
    public static final String MESSAGE_VISAGE_AMBIGUOUS_PARAM_TYPE_FROM_SUPER = "visage.ambiguous.param.type.from.super";
    public static final String MESSAGE_VISAGE_INVALID_SELECT_FOR_SUPER = "visage.invalid.select.for.super";
    public static final String MESSAGE_VISAGE_AMBIGUOUS_RETURN_TYPE_FROM_SUPER = "visage.ambiguous.return.type.from.super";
    public static final String MESSAGE_VISAGE_ITERATING_NON_SEQUENCE = "visage.iterating.non.sequence";
    public static final String MESSAGE_VISAGE_NOT_A_FUNC = "visage.not.a.function";
    public static final String MESSAGE_VISAGE_CANNOT_APPLY_FUNCTION = "visage.cant.apply.function";
    public static final String MESSAGE_VISAGE_APPLIED_TO_INSTANCE_VAR = "visage.applied.to.instance.var";
    public static final String MESSAGE_VISAGE_MUST_BE_AN_ATTRIBUTE = "visage.must.be.an.attribute"; 
    public static final String MESSAGE_VISAGE_LITERAL_OUT_OF_RANGE = "visage.lexer.literal.range";
    public static final String MESSAGE_VISAGE_BOUND_FUNCTION_MUST_NOT_BE_VOID = "visage.bound.function.must.not.be.void";
    public static final String MESSAGE_VISAGE_INVALID_ASSIGNMENT = "visage.invalid.assignment";
    public static final String MESSAGE_VISAGE_CANNOT_ASSIGN_TO_DEF = "visage.cannot.assign.to.def"; 
    public static final String MESSAGE_VISAGE_CANNOT_ASSIGN_TO_PARAMETER = "visage.cannot.assign.to.parameter";
    public static final String MESSAGE_VISAGE_REPORT_WRITE_ACCESS = "visage.report.write.access";
    public static final String MESSAGE_VISAGE_REPORT_VAR_QUERY_ACCESS = "visage.report.var.query.access";
    public static final String MESSAGE_VISAGE_REPORT_BIND_ACCESS = "visage.report.bind.access";
    public static final String MESSAGE_VISAGE_REPORT_INIT_ACCESS = "visage.report.init.access";
    public static final String MESSAGE_VISAGE_DEF_MUST_HAVE_INIT = "visage.def.must.have.init";
    public static final String MESSAGE_VISAGE_DECLARED_OVERRIDE_DOES_NOT = "visage.declared.overrride.does.not.override";
    public static final String MESSAGE_VISAGE_SHOULD_BE_DECLARED_OVERRIDE = "visage.function.overrides.another.should.be.declared.override";
    public static final String MESSAGE_VISAGE_VAR_OVERRIDES_MEMBER = "visage.var.overrides.member";
    public static final String MESSAGE_VISAGE_DEF_OVERRIDES_MEMBER = "visage.def.overrides.member";
    public static final String MESSAGE_VISAGE_VAR_OVERRIDES_JAVA_MEMBER = "visage.var.overrides.java.member";
    public static final String MESSAGE_VISAGE_DEF_OVERRIDES_JAVA_MEMBER = "visage.def.overrides.java.member";
    public static final String MESSAGE_VISAGE_STATIC_DEPRECATED = "visage.static.deprecated";
    public static final String MESSAGE_VISAGE_REDUNDANT_ACCESS_MODIFIERS = "visage.redundant.access.modifiers";
    public static final String MESSAGE_VISAGE_VAR_NOT_SUPPORTED_HERE = "visage.var.not.supported.here";
    public static final String MESSAGE_VISAGE_STRING_CONCATENATION = "visage.string.concatenation";
    public static final String MESSAGE_VISAGE_NOT_SUPPORTED_READABLE = "visage.not.supported.readable";
    public static final String MESSAGE_VISAGE_NOT_SUPPORTED_ATTRIBUTE = "visage.not.supported.attribute";
    public static final String MESSAGE_VISAGE_NOT_SUPPORTED_PRIVATE = "visage.not.supported.private";
    public static final String MESSAGE_VISAGE_BAD_STR_COMPOUND = "visage.bad.str.compound";
    public static final String MESSAGE_VISAGE_CANNOT_MODIFY_LOCALVAR = "visage.cannot.modify.localvar";
    ...
    public static final String MESSAGE_VISAGE_BAD_CHARACTER = "visage.bad.character";
    public static final String MESSAGE_VISAGE_HEX_MALFORMED = "visage.hex.malformed";
    public static final String MESSAGE_VISAGE_HEX_FLOAT = "visage.hex.float";
    public static final String MESSAGE_VISAGE_HEX_MISSING = "visage.hex.missing";
    public static final String MESSAGE_VISAGE_COLOR_WRONG_CHARACTERS = "visage.color.wrong.characters";
    public static final String MESSAGE_VISAGE_COLOR_WRONG_FORMAT = "visage.color.wrong.format";
    public static final String MESSAGE_VISAGE_COLOR_MISSING = "visage.color.missing";
    public static final String MESSAGE_VISAGE_OCTAL_MALFORMED = "visage.octal.malformed";
    public static final String MESSAGE_VISAGE_OCTAL_FLOAT = "visage.octal.float";
    public static final String MESSAGE_VISAGE_EXPONENT_MALFORMED = "visage.exponent.malformed";
    public static final String MESSAGE_VISAGE_INTERNAL_ERROR = "visage.internal.error";
    public static final String MESSAGE_VISAGE_UNTERMINATED_STRING = "visage.unterminated.string";
    public static final String MESSAGE_VISAGE_UNTERMINATED_STRING_EXPRESSION = "visage.unterminated.string.expression";
    public static final String MESSAGE_VISAGE_UNESCAPED_RBRACE = "visage.unescaped.rbrace";
    public static final String MESSAGE_VISAGE_SEMI_REQUIRED ="visage.semi.required";
    public static final String MESSAGE_VISAGE_INCOMPLETE_QUAL = "visage.incomplete.qual";
    public static final String MESSAGE_VISAGE_IMPORT_BAD_STAR = "visage.import.bad.star";
    public static final String MESSAGE_VISAGE_IMPORT_BAD_NAME = "visage.import.bad.name";
    public static final String MESSAGE_VISAGE_FUNC_UNNAMED = "visage.func.unnamed";
    public static final String MESSAGE_VISAGE_TYPED_OVERRIDE = "visage.typed.override";
    public static final String MESSAGE_VISAGE_FINALLY_TOOMANY = "visage.finally.toomany";
    public static final String MESSAGE_VISAGE_FINALLY_NOTLAST = "visage.finally.notlast";
    public static final String MESSAGE_VISAGE_BAD_TRY = "visage.bad.try";
    public static final String MESSAGE_VISAGE_ORPHANED_FINALLY = "visage.orphaned.finally";
    public static final String MESSAGE_VISAGE_ORPHANED_CATCH = "visage.orphaned.catch";
    public static final String MESSAGE_VISAGE_GARBLED_EXPRESSION = "visage.garbled.expression";
    public static final String MESSAGE_VISAGE_ORPHANED_ELSE = "visage.orphaned.else";
    public static final String MESSAGE_VISAGE_GARBLED_DECLARATION = "visage.garbled.declaration";
    public static final String MESSAGE_VISAGE_OPTIMIZATION_STATISTIC = "visage.optimization.statistic";
    public static final String MESSAGE_VISAGE_BAD_DEF = "visage.bad.def";
    public static final String MESSAGE_VISAGE_BAD_PERCENT = "visage.bad.percent";
    public static final String MESSAGE_VISAGE_NOT_NE = "visage.not.ne";
    public static final String MESSAGE_VISAGE_GENERICS_UNSUPPORTED = "visage.generics.unsupported";
    public static final String MESSAGE_VISAGE_MOD_NOT_ALLOWED_ON_LOCAL = "visage.mod.not.allowed.on.local";
    public static final String MESSAGE_VISAGE_MOD_NOT_ALLOWED_ON_SCRIPT = "visage.mod.not.allowed.on.script";
    public static final String MESSAGE_VISAGE_MOD_NOT_ALLOWED_ON_INSTANCE = "visage.mod.not.allowed.on.instance";
    public static final String MESSAGE_VISAGE_MOD_NOT_ALLOWED_ON = "visage.mod.not.allowed.on";
    public static final String MESSAGE_VISAGE_BAD_EMPTY_SEQUENCE = "visage.bad.empty.sequence";
    public static final String MESSAGE_VISAGE_BAD_SEQUENCE = "visage.bad.sequence";
    public static final String MESSAGE_VISAGE_EXPLICIT_THREAD = "visage.explicit.thread";
    public static final String MESSAGE_VISAGE_CANNOT_OVERRIDE = "visage.cannot.override";
    public static final String MESSAGE_VISAGE_CANNOT_OVERRIDE_OWN = "visage.cannot.override.own";
    public static final String MESSAGE_VISAGE_CANNOT_OVERRIDE_DEF = "visage.cannot.override.def";
    public static final String MESSAGE_VISAGE_PACKAGE_IN_SCRIPT_EVAL_MODE = "visage.package.in.script.eval.mode";
    public static final String MESSAGE_VISAGE_ALREADY_DEFINED_OBJECT_LITERAL = "visage.already.defined.object.literal";
    public static final String MESSAGE_VISAGE_CANNOT_INIT_STATIC_OBJECT_LITERAL = "visage.cannot.init.static.object.literal";
    public static final String MESSAGE_VISAGE_REPEATED_MIXIN = "visage.repeated.mixin";
    public static final String MESSAGE_VISAGE_DUPLICATE_TRIGGER_DEF = "visage.duplicate.trigger.def";
    public static final String MESSAGE_VISAGE_DUPLICATE_VAR_OVERRIDE = "visage.duplicate.var.override";
    public static final String MESSAGE_VISAGE_PURE_MIXIN = "visage.pure.mixin";
    public static final String MESSAGE_VISAGE_ONLY_MIXINS_AND_INTERFACES = "visage.only.mixins.and.interfaces";
    public static final String MESSAGE_VISAGE_MIXIN_CANNOT_BE_INSTANTIATED = "visage.mixin.cant.be.instantiated";
    public static final String MESSAGE_VISAGE_FOR_OVER_ITERABLE_DISALLOWED_IN_BIND = "visage.for.over.iterable.disallowed.in.bind";
    public static final String MESSAGE_VISAGE_KEYVALUE_REQUIRED = "visage.keyvalue.required";
    public static final String MESSAGE_VISAGE_MANDATORY_COMMA = "visage.mandatory.comma";
    public static final String MESSAGE_VISAGE_TYPES_INCOMPATIBLE_VARS = "visage.types.incompatible.vars";
    public static final String MESSAGE_VISAGE_WARN_ON_USE_PACKAGE = "visage.warn.on.use.package";
    public static final String MESSAGE_VISAGE_MULTIPLE_DEFAULT_VARS = "visage.multiple.default.vars";
    public static final String MESSAGE_VISAGE_NO_DEFAULT_DECLARED = "visage.no.default.declared";
}
