...
public class VisageFileManager extends JavacFileManager {
    ...
    /**
     * Register a Context.Factory to create a VisageFileManager.
     */
    public static void preRegister(final Context context) {
        context.put(JavaFileManager.class, new Context.Factory<JavaFileManager>() {
            public JavaFileManager make() {
                return new VisageFileManager(context, true, null);
            }
        });
    }

    public VisageFileManager(Context context, boolean register, Charset charset) {
    ...
    private static class DelegateJavaFileObject extends BaseFileObject {
        ...
        public boolean isNameCompatible(String cn, Kind kind) {
            ...
            if (kind == Kind.OTHER && getKind() != kind)
                return false;
            String suffix = (kind == JavaFileObject.Kind.SOURCE) ? ".visage" : kind.extension;
            String n = cn + suffix;
