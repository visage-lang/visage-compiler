...
public class JavafxScriptClassBuilder {
    protected static final Context.Key<JavafxScriptClassBuilder> visageModuleBuilderKey =
    ...
    public static JavafxScriptClassBuilder instance(Context context) {
        JavafxScriptClassBuilder instance = context.get(visageModuleBuilderKey);
        if (instance == null)
