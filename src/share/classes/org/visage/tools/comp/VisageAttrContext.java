 ...
 */
public class VisageAttrContext {
     ...
     */
    VisageAttrContext dup(Scope scope) {
        VisageAttrContext info = new VisageAttrContext();
        info.scope = scope;
    ...
    public String toString() {
        return "VisageAttrContext[" + scope.toString() + "]";
    }
}
