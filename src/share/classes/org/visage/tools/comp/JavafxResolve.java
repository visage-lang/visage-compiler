...
public class JavafxResolve {
    protected static final Context.Key<JavafxResolve> visageResolveKey =
    ...
    public static JavafxResolve instance(Context context) {
        JavafxResolve instance = context.get(visageResolveKey);
        if (instance == null)
 ...
 ****************************************************************************/
     ...
     */
    public Symbol findField(JavafxEnv<JavafxAttrContext> env,
                     Type site,
                     Name name,
                     TypeSymbol c) {
