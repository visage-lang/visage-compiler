...
public class JavafxInitializationBuilder extends JavafxTranslationSupport {
    protected static final Context.Key<JavafxInitializationBuilder> visageInitializationBuilderKey =
    ...
    public static JavafxInitializationBuilder instance(Context context) {
        JavafxInitializationBuilder instance = context.get(visageInitializationBuilderKey);
        if (instance == null)
        ...
        public void makeAttributeFields(List<? extends VarInfo> attrInfos) {
            for (VarInfo ai : attrInfos) {
                ...
                if (ai.needsCloning() && !ai.isOverride()) {
                    ...
                    if (ai.isDefault()) flags |= JavafxFlags.DEFAULT;
...
however this is what we need */ 
        ...
        private JCExpression validBindeesTest(VarInfo varInfo) {
            ...
            if (unique.size() == 0) {
                ...
                for (JavafxVarSymbol vsym : unique) {
