...
public class JavafxCheck {
    protected static final Context.Key<JavafxCheck> visageCheckKey =
    ...
    public static JavafxCheck instance(Context context) {
        JavafxCheck instance = context.get(visageCheckKey);
        if (instance == null)
    ...
    public static void preRegister(final Context context) {
        context.put(visageCheckKey, new Context.Factory<JavafxCheck>() {
