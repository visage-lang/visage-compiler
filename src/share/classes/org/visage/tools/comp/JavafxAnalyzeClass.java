...
class JavafxAnalyzeClass {
    ...
    // List of vars (attributes) found in the current visage class (supplied by JavafxInitializationBuilder.)
    private final List<TranslatedVarInfo> translatedAttrInfo;

    // List of overriding vars (attributes) found in the current visage class (supplied by JavafxInitializationBuilder.)
    private final List<TranslatedOverrideClassVarInfo> translatedOverrideAttrInfo;

    // List of functions (methods) found in the current visage class (supplied by JavafxInitializationBuilder.)
