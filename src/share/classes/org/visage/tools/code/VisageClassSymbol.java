 ...
 * @author llitchev
 */
public class VisageClassSymbol extends ClassSymbol {
    public ClassSymbol jsymbol;
    public VisageClassSymbol scriptSymbol;
    public VisageVarSymbol thisSymbol;
    public VisageVarSymbol superSymbol;
    public VisageVarSymbol scriptAccessSymbol;
    private boolean isScriptingModeScript;
    private int memberVarCount = 0;
    private int scriptVarCount = 0;
    private Name defaultVar;
    
    /** Creates a new instance of VisageClassSymbol */
    public VisageClassSymbol(long flags, Name name, Symbol owner) {
    ...
    public boolean isSubClass(Symbol base, Types types) {
        ...
        if (this == base) {
            return true;
        } else if ((base.flags() & (INTERFACE | VisageFlags.MIXIN)) != 0) {
    ...
    public void addVar(VisageVarSymbol vsym, boolean isScriptVar) {
