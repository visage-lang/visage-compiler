...
public class JavafxSymtab extends Symtab {
    ...
    JavafxSymtab(Context context) {
        ...
        visage_SequenceType = enterClass(JavafxDefs.cSequence);
        visage_SequenceRefType = enterClass(JavafxDefs.cSequenceRef);
        visage_SequenceProxyType = enterClass(JavafxDefs.cSequenceProxy);
        visage_ArraySequenceType = enterClass(JavafxDefs.cArraySequence);
        visage_SequencesType = enterClass(JavafxDefs.cSequences);
        ...
        visage_FXForPartInterfaceType = enterClass(JavafxDefs.cBoundForPartI);
        visage_NonLocalReturnExceptionType = enterClass(JavafxDefs.cNonLocalReturnException);
        visage_NonLocalBreakExceptionType = enterClass(JavafxDefs.cNonLocalBreakException);
        visage_NonLocalContinueExceptionType = enterClass(JavafxDefs.cNonLocalContinueException);
        ...
        visage_FXObjectType = enterClass(JavafxDefs.cFXObject);
        visage_FXMixinType = enterClass(JavafxDefs.cFXMixin);
        visage_FXBaseType = enterClass(JavafxDefs.cFXBase);
