...
public class VisageLint extends Lint{
    ...
    public static void preRegister(final Context context) {
        context.put(lintKey, new Context.Factory<Lint>() {
            //@Override
            public Lint make() {
                return new VisageLint(context);
            }
        });
    }
    
    public VisageLint(Lint other) {
        super(other);
    }

    public VisageLint(Context context) {
        super(context);
    }
