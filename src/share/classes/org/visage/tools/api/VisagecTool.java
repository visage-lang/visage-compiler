...
import org.visage.tools.main.VisageOption;
 ...
 * @author Tom Ball
 */
public final class VisagecTool implements VisageCompiler {
    ...
    private final Main sharedCompiler = new Main("visagec", silent);
    {
     ...
     */
    public static VisagecTool create() {
        return new VisagecTool();
    }
    ...
    public JavacFileManager getStandardFileManager(
        ...
        return new VisageFileManager(context, true, charset);
    }

    //@Override
    public VisagecTask getTask(Writer out,
   ...
   public VisagecTaskImpl getTask(Context context,
                             Writer out,
                             JavaFileManager fileManager,
                             DiagnosticListener<? super JavaFileObject> diagnosticListener,
                             Iterable<String> options,
    ...
    
    {
        ...
        return new VisagecTaskImpl(this, compiler, options, context, compilationUnits);
    }
                                       ...
                                       Iterable<String> options)
    {
        ...
        VisageOption[] recognizedOptions =
        ...
        while (flags.hasNext()) {
            ...
            VisageOption option = recognizedOptions[j];
            if (option.hasArg()) {
                if (!flags.hasNext()) {
    ...
    public int isSupportedOption(String option) {
        VisageOption[] recognizedOptions =
            RecognizedOptions.getJavacToolOptions(new GrumpyHelper());
        for (VisageOption o : recognizedOptions) {
            if (o.matches(option))
                return o.hasArg() ? 1 : 0;
        }
        return -1;
