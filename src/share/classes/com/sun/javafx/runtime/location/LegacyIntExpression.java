 ...
 * @author Brian Goetz
 */
public abstract class LegacyIntExpression extends AbstractIntLocation
        implements IntLocation, BindableLocation<IntBindingExpression> {

    protected IntBindingExpression binding;
    protected boolean isLazy;

    public LegacyIntExpression(boolean lazy, Location... dependencies) {
        super(false);
        bind(new IntBindingExpression() {
            public int computeValue() {
                return LegacyIntExpression.this.computeValue();
            }
        }, lazy);
