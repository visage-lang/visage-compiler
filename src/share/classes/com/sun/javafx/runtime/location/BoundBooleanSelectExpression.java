...
/**
 * BoundBooleanSelectExpression
 *
 * @author Robert Field
 */
public abstract class BoundBooleanSelectExpression<U> extends IndirectBooleanExpression implements BooleanLocation {
    private final ObjectLocation<U> selector;

    public BoundBooleanSelectExpression(ObjectLocation<U> selector) {
        super(false /*lazy*/, selector);
        this.selector = selector;
    }

    protected abstract BooleanLocation computeSelect(U selectorValue);
    ...
    protected BooleanLocation computeLocation() {
        ...
        if (selectorValue == null) {
            ...
            BooleanLocation result = computeSelect(selectorValue);
