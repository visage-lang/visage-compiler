 ...
 * @author Brian Goetz
 */
public abstract class LegacyBooleanExpression extends AbstractBooleanLocation
        implements BooleanLocation, BindableLocation<BooleanBindingExpression> {

    protected BooleanBindingExpression binding;
    protected boolean isLazy;

    public LegacyBooleanExpression(boolean lazy, Location... dependencies) {
        super(false);
        bind(new BooleanBindingExpression() {
            public boolean computeValue() {
                return LegacyBooleanExpression.this.computeValue();
            }
        }, lazy);
