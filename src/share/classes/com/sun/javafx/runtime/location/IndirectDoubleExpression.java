 ...
 * @author Brian Goetz
 */
public abstract class IndirectDoubleExpression extends DoubleExpression implements IndirectLocation<DoubleLocation> {

    private final IndirectLocationHelper<DoubleLocation> helper;
