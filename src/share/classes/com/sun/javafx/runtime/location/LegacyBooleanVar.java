 ...
 * @author Brian Goetz
 */
public class LegacyBooleanVar extends AbstractBooleanLocation implements BooleanLocation, MutableLocation {
    ...
    public static BooleanLocation make(boolean value) {
        return new LegacyBooleanVar(value);
    }

    public static BooleanLocation makeUnmodifiable(boolean value) {
        return Locations.unmodifiableLocation(new LegacyBooleanVar(value));
    }


    private LegacyBooleanVar(boolean value) {
        super(true, value);
    }
