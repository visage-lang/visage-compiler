 ...
 * @author Brian Goetz
 */
public abstract class LegacyObjectExpression<T> extends AbstractObjectLocation<T>
        implements ObjectLocation<T>, BindableLocation<ObjectBindingExpression<T>> {

    protected ObjectBindingExpression<T> binding;
    protected boolean isLazy;

    public LegacyObjectExpression(boolean lazy, Location... dependencies) {
        super(false);
        bind(new ObjectBindingExpression<T>() {
            public T computeValue() {
                return LegacyObjectExpression.this.computeValue();
            }
        }, lazy);
