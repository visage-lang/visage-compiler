 ...
 * @author Brian Goetz
 */
public abstract class LegacySequenceExpression<T> extends AbstractSequenceLocation<T>
    ...
    public LegacySequenceExpression(Class<T> clazz, boolean lazy, Location... dependencies) {
        super(clazz, false);
        bind(new SequenceBindingExpression<T>() {
            public Sequence<? extends T> computeValue() {
                return LegacySequenceExpression.this.computeValue();
            }
        }, lazy);
