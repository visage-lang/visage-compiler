...
public abstract class Location {
    ...
    public double  asDouble()  { throw new IllegalArgumentException(); }
    public Object  asObject()  { throw new IllegalArgumentException(); }
    public boolean asBoolean() { throw new IllegalArgumentException(); }
    public int     asInt()     { throw new IllegalArgumentException(); }
    
    public void setDouble(double value)   { throw new IllegalArgumentException(); }
    public void setObject(Object value)   { throw new IllegalArgumentException(); }
    public void setBoolean(boolean value) { throw new IllegalArgumentException(); }
    public void setInt(int value)         { throw new IllegalArgumentException(); }
