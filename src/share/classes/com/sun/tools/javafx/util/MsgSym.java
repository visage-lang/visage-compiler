...
public class MsgSym {
    ...
    public static final String MESSAGE_JAVAFX_UNEXPECTED_TREE = "javafx.unexpected.tree"; 
    ...
    public static final String MESSAGE_JAVAFX_RANGE_STEP_REQUIRED_NUMBER = "javafx.range.step.required.number"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_MODULE_MEMBER = "javafx.duplicate.module.member"; 
    public static final String MESSAGE_JAVAFX_MEMBER_ATTR_NOT_IN_CLASS = "javafx.member.attr.not.in.class"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_ATTR_IN_CLASS = "javafx.duplicate.attribute.in.class"; 
    public static final String MESSAGE_JAVAFX_NO_ATTR_DEFINITION = "javafx.no.attr.definition"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_ATTR_DECLARATION = "javafx.duplicate.attr.declaration"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_ATTR_DEFINITION = "javafx.duplicate.attr.definition"; 
    public static final String MESSAGE_JAVAFX_MEMBER_FUNC_NOT_IN_CLASS = "javafx.member.function.not.in.class"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_FUNC_IN_CLASS = "javafx.duplicate.function.in.class"; 
    public static final String MESSAGE_JAVAFX_NO_FUNC_DEFINITION = "javafx.no.func.definition"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_FUNC_DECLARATION = "javafx.duplicate.func.declaration"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_FUNC_DEFINITION = "javafx.duplicate.func.definition"; 
    public static final String MESSAGE_JAVAFX_MEMBER_OPER_NOT_IN_CLASS = "javafx.member.operation.not.in.class"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_OPER_IN_CLASS = "javafx.duplicate.operation.in.class"; 
    public static final String MESSAGE_JAVAFX_NO_OPER_DEFINITION = "javafx.no.oper.definition"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_OPER_DECLARATION = "javafx.duplicate.oper.declaration"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_OPER_DEFINITION = "javafx.duplicate.oper.definition"; 
    public static final String MESSAGE_JAVAFX_MEMBER_ATTR_NOT_IN_MODULE = "javafx.member.attr.not.in.module"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_ATTR_IN_MODULE = "javafx.duplicate.attribute.in.module"; 
    public static final String MESSAGE_JAVAFX_NO_ATTR_DECLARATION = "javafx.no.attr.declaration"; 
    public static final String MESSAGE_JAVAFX_MEMBER_FUNC_NOT_IN_MODULE = "javafx.member.func.not.in.module"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_FUNC_IN_MODULE = "javafx.duplicate.function.in.module"; 
    public static final String MESSAGE_JAVAFX_NO_FUNC_DECLARATION = "javafx.no.func.declaration"; 
    public static final String MESSAGE_JAVAFX_MEMBER_OPER_NOT_IN_MODULE = "javafx.member.oper.not.in.module"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_OPER_IN_MODULE = "javafx.duplicate.operation.in.module"; 
    public static final String MESSAGE_JAVAFX_NO_OPER_DECLARATION = "javafx.no.oper.declaration"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_LOCAL_OPER_DEFINITON = "javafx.duplicate.local.operation.definition"; 
    public static final String MESSAGE_JAVAFX_DUPLICATE_LOCAL_FUNC_DEFINITION = "javafx.duplicate.local.function.definition"; 
    public static final String MESSAGE_JAVAFX_MEMBER_DEF_WITH_NO_DECL = "javafx.member.def.with.no.decl"; 
    public static final String MESSAGE_JAVAFX_TRIGGER_WITH_NO_BODY = "javafx.trigger.with.no.body"; 
    public static final String MESSAGE_JAVAFX_TRIGGER_WITH_NO_OWNER = "javafx.trigger.with.no.owner"; 
    public static final String MESSAGE_JAVAFX_INDEXOF_NOT_FOUND = "javafx.indexof.not.found"; 
    public static final String MESSAGE_JAVAFX_NOT_YET_IMPLEMENTED = "javafx.not.yet.implemented"; 
    public static final String MESSAGE_JAVAFX_DIFFERENT_NUMBER_OF_PARAMETERS_FOR_DEFINITION_AND_DECLARATION = "javafx.different.number.of.parameters.for.definition.and.declaration"; 
    public static final String MESSAGE_JAVAFX_DIFFERENT_TYPES_OF_PARAMETERS_FOR_DEFINITON_AND_DECLARATION = "javafx.different.types.of.parameters.for.definition.and.declaration"; 
    public static final String MESSAGE_JAVAFX_CANNOT_INFER_RETURN_TYPE = "javafx.cannot.infer.return.type"; 
    public static final String MESSAGE_JAVAFX_DIFFERENT_TYPES_OF_RESULT_FOR_DEFINITION_AND_DECLARATION = "javafx.different.types.of.result.for.definition.and.declaration"; 
    ...
    public static final String MESSAGE_JAVAFX_OLD_STYLE_TRIGGERS_NOT_SUPPORTED = "javafx.old.style.triggers.not.supported"; 
