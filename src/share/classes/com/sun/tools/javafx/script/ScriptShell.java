...
public class ScriptShell implements DiagnosticListener<JavaFileObject> {
    ...
    protected String formatDiagnostic(Diagnostic<? extends JavaFileObject> diagnostic) {
        return "fx"+counter+":"+diagnostic.getLineNumber()+": "+diagnostic.getMessage(null);
    }
    ...
    private void initScriptEngine() {
        // load init.fx file from resource
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        InputStream sysIn = cl.getResourceAsStream("com/sun/tools/script/shell/init.fx");
        if (sysIn != null) {
