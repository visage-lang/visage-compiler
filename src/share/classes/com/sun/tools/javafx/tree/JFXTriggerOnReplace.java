 ...
 * Trigger on
 */
public class JFXTriggerOnReplace extends JFXAbstractTriggerOn {
    public JFXMemberSelector selector;
    public JCExpression identifier;
    
    protected JFXTriggerOnReplace(
    ...
    public void accept(JavafxVisitor v) { v.visitTriggerOnReplace(this); }
