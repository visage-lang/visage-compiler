 ...
 * @author Robert Field
 */
public class JFXVarInit extends JFXVarStatement {
    public JCExpression initializer;
    private JavafxBindStatus bindStatus;
    
    protected JFXVarInit(Name name,
            JFXType type,
    ...
    public void accept(JavafxVisitor v) { v.visitVarInit(this); }
    
    public JCExpression getInitializer() { return initializer; }
