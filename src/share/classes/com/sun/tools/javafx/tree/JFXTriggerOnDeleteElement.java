 ...
 * Trigger on
 */
public class JFXTriggerOnDeleteElement extends JFXAbstractTriggerOn {
    public JFXMemberSelector selector;
    public JCExpression identifier;
    
    protected JFXTriggerOnDeleteElement(
            JFXMemberSelector selector,
            JCExpression identifier,
            JCBlock block) {
        super(JavafxTag.TRIGGERONDELETEELEMENT, block);
        this.selector = selector;
        this.identifier = identifier;
    }
    public void accept(JavafxVisitor v) { v.visitTriggerOnDeleteElement(this); }
