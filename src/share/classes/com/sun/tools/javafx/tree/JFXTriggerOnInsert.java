 ...
 * Trigger on
 */
public class JFXTriggerOnInsert extends JFXAbstractTriggerOn {
    public JFXMemberSelector selector;
    public JCExpression identifier;
    
    protected JFXTriggerOnInsert(
            JFXMemberSelector selector,
            JCExpression identifier,
            JCBlock block) {
        super(JavafxTag.TRIGGERONINSERT, block);
        this.selector = selector;
        this.identifier = identifier;
    }
    public void accept(JavafxVisitor v) { v.visitTriggerOnInsert(this); }
