...
public class JavafxFlags {
    ...
    public static final long ASSIGNED_TO               = FIRST_FX_MISC_FLAG << 1;  // assigned-to used by attribution and not currently correct
    public static final long IN_INITIALIZER            = FIRST_FX_MISC_FLAG << 2;  // temporary flag set while in var init expression
    public static final long SCRIPT_LEVEL_SYNTH_STATIC = FIRST_FX_MISC_FLAG << 3;  // STATIC bit has been set implicitly
    private static final long LAST_FX_MISC_FLAG        = SCRIPT_PRIVATE;

    // All usage info is within the script only
    ...
    public static final long VARUSE_ASSIGN_TO        = FIRST_VARUSE_FLAG << 3;  // assigned ("=") to outside of an init
    public static final long VARUSE_INIT_ASSIGNED    = FIRST_VARUSE_FLAG << 4;  // assigned to inside of an init
