 ...
 * @author Robert Field
 */
public class MTVar extends MTVariableDecl {
    private final MTType jfxtype;
    private final JavafxBindStatus bindStatus;
    private final List<MTAbstractOnChange> onChanges;
    
    protected MTVar(Name name,
            MTType jfxtype,
            MTModifiers mods,
            MTExpression init,
    ...
    public void accept(MTVisitor v) { v.visitVar(this); }

    public MTType getJFXType() {
        return jfxtype;
    }

    public List<MTAbstractOnChange> getOnChanges() {
        return onChanges;
    }
