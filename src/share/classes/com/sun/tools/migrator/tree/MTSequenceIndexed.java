 ...
 * @author Robert Field
 */
public class MTSequenceIndexed extends MTExpression {
    private final MTExpression sequence;
    private final MTExpression index;

    public MTSequenceIndexed(MTExpression sequence, MTExpression index) {
