...
public class MsgSym {
    ...
    public static final String MESSAGE_JAVAFX_NOTE_INTERNAL_ERROR = "visage.internal.error";
    public static final String MESSAGE_JAVAFX_NOTE_INTERNAL_ERROR1 = "visage.internal.error1";
    public static final String MESSAGE_JAVAFX_NOTE_INTERNAL_ERROR2 = "visage.internal.error2";
    public static final String MESSAGE_JAVAFX_OPT_ARG_NAME = "visage.opt.arg.name"; 
    public static final String MESSAGE_JAVAFX_OPT_PLATFORM = "visage.opt.platform"; 
    ...
    public static final String MESSAGE_OPT_CLASSPATH = "visage.opt.classpath";
    ...
    public static final String MESSAGE_TOO_MANY_PARAMETERS = "visage.too.many.parameters";
    public static final String MESSAGE_BIND_TOO_COMPLEX = "visage.bind.too.complex";
    ...
    public static final String MESSAGE_JAVAFX_RANGE_END_INT_OR_NUMBER = "visage.range.end.int.or.number"; 
    public static final String MESSAGE_JAVAFX_RANGE_STEP_INT_OR_NUMBER = "visage.range.step.int.or.number"; 
    public static final String MESSAGE_JAVAFX_RANGE_LITERAL_EMPTY = "visage.range.literal.empty"; 
    public static final String MESSAGE_JAVAFX_RESERVED_TOP_LEVEL_SCRIPT_MEMBER = "visage.reserved.top.level.script.member";
    public static final String MESSAGE_JAVAFX_LOOSE_EXPRESSIONS = "visage.loose.expressions";
    public static final String MESSAGE_JAVAFX_RUN_FUNCTION_SINGLE = "visage.run.function.single";
    public static final String MESSAGE_JAVAFX_RUN_FUNCTION_PARAM = "visage.run.function.param";
    public static final String MESSAGE_JAVAFX_INDEXOF_NOT_FOUND = "visage.indexof.not.found";
    public static final String MESSAGE_JAVAFX_KEYFRAME_LIT = "visage.keyframe.literal";
    public static final String MESSAGE_JAVAFX_SELF_REFERENCE = "visage.self.ref";
    public static final String MESSAGE_JAVAFX_FORWARD_REFERENCE = "visage.forward.ref";
    public static final String MESSAGE_JAVAFX_TRY_CATCH = "visage.try.catch";
    public static final String MESSAGE_JAVAFX_SEQ_OR_ARRAY = "visage.seq.or.array";
    public static final String MESSAGE_JAVAFX_OBJ_OR_SEQ = "visage.obj.or.seq";
    public static final String MESSAGE_JAVAFX_LOOSE_IN_LIB = "visage.loose.expr.in.lib";
    public static final String MESSAGE_JAVAFX_LOOSE_IN_RUN = "visage.loose.expr.in.run";
    public static final String MESSAGE_JAVAFX_CANNOT_INFER_RETURN_TYPE = "visage.cannot.infer.return.type"; 
    public static final String MESSAGE_JAVAFX_TYPE_INFER_CYCLE_FUN_DECL = "visage.type.infer.cycle.fun.decl";
    public static final String MESSAGE_JAVAFX_TYPE_INFER_CYCLE_VAR_DECL = "visage.type.infer.cycle.var.decl";
    public static final String MESSAGE_JAVAFX_TYPE_INFER_CYCLE_VAR_REF = "visage.type.infer.cycle.var.ref";
    public static final String MESSAGE_JAVAFX_FUNC_TYPE_INFER_CYCLE = "visage.function.type.infer.cycle";
    public static final String MESSAGE_JAVAFX_VOID_SEQUENCE_NOT_ALLOWED = "visage.void.sequence.not.allowed";
    public static final String MESSAGE_JAVAFX_VOID_BLOCK_VALUE_NOT_ALLOWED = "visage.void.block.val.not.allowed";
    public static final String MESSAGE_JAVAFX_ONLY_ONE_BASE_JAVA_CLASS_ALLOWED = "visage.only.one.base.java.class.allowed"; 
    public static final String MESSAGE_JAVAFX_ONLY_ONE_BASE_CLASS_ALLOWED = "visage.only.one.base.class.allowed";
    public static final String MESSAGE_NEW_FX_CLASS_NO_ARGS = "new.fxclass.no.args";
    public static final String MESSAGE_JAVAFX_NOT_ALLOWED_IN_BIND_CONTEXT = "visage.not.allowed.in.bind.context";
    public static final String MESSAGE_JAVAFX_EXPR_UNSUPPORTED_FOR_BIDI_BIND = "visage.expr.unsupported.for.bidi.bind";    
    public static final String MESSAGE_JAVAFX_UNSUPPORTED_TYPE_IN_BIND = "visage.unsupported.type.in.bind";
    public static final String MESSAGE_JAVAFX_UNSUPPORTED_TYPE_IN_TRIGGER = "visage.unsupported.type.in.trigger";
    public static final String MESSAGE_JAVAFX_WRONG_TYPE_FOR_BIDI_BIND = "visage.wrong.type.for.bidi.bind";
    public static final String MESSAGE_JAVAFX_BOUND_VAR_IN_BIDI_BIND = "visage.bound.var.in.bidi.bind";
    public static final String MESSAGE_SELECT_TARGET_NOT_REEVALUATED_FOR_BIDI_BIND = "visage.select.target.not.reevaluated.for.bidi.bind";
    public static final String MESSAGE_SELECT_TARGET_NOT_REEVALUATED_FOR_ANIM = "visage.select.target.not.reevaluated.for.anim";
    public static final String MESSAGE_JAVAFX_BOUND_OVERRIDE_METH = "visage.bound.override.meth";
    public static final String MESSAGE_JAVAFX_NON_BOUND_OVERRIDE_METH = "visage.non.bound.override.meth";
    public static final String MESSAGE_JAVAFX_CANNOT_OVERRIDE_CLASS_VAR_FROM_FUNCTION = "visage.cant.override.var.from.func";
    public static final String MESSAGE_JAVAFX_BASE_JAVA_CLASS_NON_PAPAR_CTOR = "visage.base.java.class.non.papar.ctor"; 
    public static final String MESSAGE_JAVAFX_AMBIGUOUS_PARAM_TYPE_FROM_SUPER = "visage.ambiguous.param.type.from.super";
    public static final String MESSAGE_JAVAFX_INVALID_SELECT_FOR_SUPER = "visage.invalid.select.for.super";
    public static final String MESSAGE_JAVAFX_AMBIGUOUS_RETURN_TYPE_FROM_SUPER = "visage.ambiguous.return.type.from.super";
    public static final String MESSAGE_JAVAFX_ITERATING_NON_SEQUENCE = "visage.iterating.non.sequence";
    public static final String MESSAGE_JAVAFX_NOT_A_FUNC = "visage.not.a.function";
    public static final String MESSAGE_JAVAFX_CANNOT_APPLY_FUNCTION = "visage.cant.apply.function";
    public static final String MESSAGE_JAVAFX_APPLIED_TO_INSTANCE_VAR = "visage.applied.to.instance.var";
    public static final String MESSAGE_JAVAFX_MUST_BE_AN_ATTRIBUTE = "visage.must.be.an.attribute"; 
    public static final String MESSAGE_JAVAFX_LITERAL_OUT_OF_RANGE = "visage.lexer.literal.range";
    public static final String MESSAGE_JAVAFX_BOUND_FUNCTION_MUST_NOT_BE_VOID = "visage.bound.function.must.not.be.void";
    public static final String MESSAGE_JAVAFX_INVALID_ASSIGNMENT = "visage.invalid.assignment";
    public static final String MESSAGE_JAVAFX_CANNOT_ASSIGN_TO_DEF = "visage.cannot.assign.to.def"; 
    public static final String MESSAGE_JAVAFX_CANNOT_ASSIGN_TO_PARAMETER = "visage.cannot.assign.to.parameter";
    public static final String MESSAGE_JAVAFX_REPORT_WRITE_ACCESS = "visage.report.write.access";
    public static final String MESSAGE_JAVAFX_REPORT_VAR_QUERY_ACCESS = "visage.report.var.query.access";
    public static final String MESSAGE_JAVAFX_REPORT_BIND_ACCESS = "visage.report.bind.access";
    public static final String MESSAGE_JAVAFX_REPORT_INIT_ACCESS = "visage.report.init.access";
    public static final String MESSAGE_JAVAFX_DEF_MUST_HAVE_INIT = "visage.def.must.have.init";
    public static final String MESSAGE_JAVAFX_DECLARED_OVERRIDE_DOES_NOT = "visage.declared.overrride.does.not.override";
    public static final String MESSAGE_JAVAFX_SHOULD_BE_DECLARED_OVERRIDE = "visage.function.overrides.another.should.be.declared.override";
    public static final String MESSAGE_JAVAFX_VAR_OVERRIDES_MEMBER = "visage.var.overrides.member";
    public static final String MESSAGE_JAVAFX_DEF_OVERRIDES_MEMBER = "visage.def.overrides.member";
    public static final String MESSAGE_JAVAFX_VAR_OVERRIDES_JAVA_MEMBER = "visage.var.overrides.java.member";
    public static final String MESSAGE_JAVAFX_DEF_OVERRIDES_JAVA_MEMBER = "visage.def.overrides.java.member";
    public static final String MESSAGE_JAVAFX_STATIC_DEPRECATED = "visage.static.deprecated";
    public static final String MESSAGE_JAVAFX_REDUNDANT_ACCESS_MODIFIERS = "visage.redundant.access.modifiers";
    public static final String MESSAGE_JAVAFX_VAR_NOT_SUPPORTED_HERE = "visage.var.not.supported.here";
    public static final String MESSAGE_JAVAFX_STRING_CONCATENATION = "visage.string.concatenation";
    public static final String MESSAGE_JAVAFX_NOT_SUPPORTED_READABLE = "visage.not.supported.readable";
    public static final String MESSAGE_JAVAFX_NOT_SUPPORTED_ATTRIBUTE = "visage.not.supported.attribute";
    public static final String MESSAGE_JAVAFX_NOT_SUPPORTED_PRIVATE = "visage.not.supported.private";
    public static final String MESSAGE_JAVAFX_BAD_STR_COMPOUND = "visage.bad.str.compound";
    public static final String MESSAGE_JAVAFX_CANNOT_MODIFY_LOCALVAR = "visage.cannot.modify.localvar";
    ...
    public static final String MESSAGE_JAVAFX_BAD_CHARACTER = "visage.bad.character";
    public static final String MESSAGE_JAVAFX_HEX_MALFORMED = "visage.hex.malformed";
    public static final String MESSAGE_JAVAFX_HEX_FLOAT = "visage.hex.float";
    public static final String MESSAGE_JAVAFX_HEX_MISSING = "visage.hex.missing";
    public static final String MESSAGE_JAVAFX_COLOR_WRONG_CHARACTERS = "visage.color.wrong.characters";
    public static final String MESSAGE_JAVAFX_COLOR_WRONG_FORMAT = "visage.color.wrong.format";
    public static final String MESSAGE_JAVAFX_COLOR_MISSING = "visage.color.missing";
    public static final String MESSAGE_JAVAFX_OCTAL_MALFORMED = "visage.octal.malformed";
    public static final String MESSAGE_JAVAFX_OCTAL_FLOAT = "visage.octal.float";
    public static final String MESSAGE_JAVAFX_EXPONENT_MALFORMED = "visage.exponent.malformed";
    public static final String MESSAGE_JAVAFX_INTERNAL_ERROR = "visage.internal.error";
    public static final String MESSAGE_JAVAFX_UNTERMINATED_STRING = "visage.unterminated.string";
    public static final String MESSAGE_JAVAFX_UNTERMINATED_STRING_EXPRESSION = "visage.unterminated.string.expression";
    public static final String MESSAGE_JAVAFX_UNESCAPED_RBRACE = "visage.unescaped.rbrace";
    public static final String MESSAGE_JAVAFX_SEMI_REQUIRED ="visage.semi.required";
    public static final String MESSAGE_JAVAFX_INCOMPLETE_QUAL = "visage.incomplete.qual";
    public static final String MESSAGE_JAVAFX_IMPORT_BAD_STAR = "visage.import.bad.star";
    public static final String MESSAGE_JAVAFX_IMPORT_BAD_NAME = "visage.import.bad.name";
    public static final String MESSAGE_JAVAFX_FUNC_UNNAMED = "visage.func.unnamed";
    public static final String MESSAGE_JAVAFX_TYPED_OVERRIDE = "visage.typed.override";
    public static final String MESSAGE_JAVAFX_FINALLY_TOOMANY = "visage.finally.toomany";
    public static final String MESSAGE_JAVAFX_FINALLY_NOTLAST = "visage.finally.notlast";
    public static final String MESSAGE_JAVAFX_BAD_TRY = "visage.bad.try";
    public static final String MESSAGE_JAVAFX_ORPHANED_FINALLY = "visage.orphaned.finally";
    public static final String MESSAGE_JAVAFX_ORPHANED_CATCH = "visage.orphaned.catch";
    public static final String MESSAGE_JAVAFX_GARBLED_EXPRESSION = "visage.garbled.expression";
    public static final String MESSAGE_JAVAFX_ORPHANED_ELSE = "visage.orphaned.else";
    public static final String MESSAGE_JAVAFX_GARBLED_DECLARATION = "visage.garbled.declaration";
    public static final String MESSAGE_JAVAFX_OPTIMIZATION_STATISTIC = "visage.optimization.statistic";
    public static final String MESSAGE_JAVAFX_BAD_DEF = "visage.bad.def";
    public static final String MESSAGE_JAVAFX_BAD_PERCENT = "visage.bad.percent";
    public static final String MESSAGE_JAVAFX_NOT_NE = "visage.not.ne";
    public static final String MESSAGE_JAVAFX_GENERICS_UNSUPPORTED = "visage.generics.unsupported";
    public static final String MESSAGE_JAVAFX_MOD_NOT_ALLOWED_ON_LOCAL = "visage.mod.not.allowed.on.local";
    public static final String MESSAGE_JAVAFX_MOD_NOT_ALLOWED_ON_SCRIPT = "visage.mod.not.allowed.on.script";
    public static final String MESSAGE_JAVAFX_MOD_NOT_ALLOWED_ON_INSTANCE = "visage.mod.not.allowed.on.instance";
    public static final String MESSAGE_JAVAFX_MOD_NOT_ALLOWED_ON = "visage.mod.not.allowed.on";
    public static final String MESSAGE_JAVAFX_BAD_EMPTY_SEQUENCE = "visage.bad.empty.sequence";
    public static final String MESSAGE_JAVAFX_BAD_SEQUENCE = "visage.bad.sequence";
    public static final String MESSAGE_JAVAFX_EXPLICIT_THREAD = "visage.explicit.thread";
    public static final String MESSAGE_JAVAFX_CANNOT_OVERRIDE = "visage.cannot.override";
    public static final String MESSAGE_JAVAFX_CANNOT_OVERRIDE_OWN = "visage.cannot.override.own";
    public static final String MESSAGE_JAVAFX_CANNOT_OVERRIDE_DEF = "visage.cannot.override.def";
    public static final String MESSAGE_JAVAFX_PACKAGE_IN_SCRIPT_EVAL_MODE = "visage.package.in.script.eval.mode";
    public static final String MESSAGE_JAVAFX_ALREADY_DEFINED_OBJECT_LITERAL = "visage.already.defined.object.literal";
    public static final String MESSAGE_JAVAFX_CANNOT_INIT_STATIC_OBJECT_LITERAL = "visage.cannot.init.static.object.literal";
    public static final String MESSAGE_JAVAFX_REPEATED_MIXIN = "visage.repeated.mixin";
    public static final String MESSAGE_JAVAFX_DUPLICATE_TRIGGER_DEF = "visage.duplicate.trigger.def";
    public static final String MESSAGE_JAVAFX_DUPLICATE_VAR_OVERRIDE = "visage.duplicate.var.override";
    public static final String MESSAGE_JAVAFX_PURE_MIXIN = "visage.pure.mixin";
    public static final String MESSAGE_JAVAFX_ONLY_MIXINS_AND_INTERFACES = "visage.only.mixins.and.interfaces";
    public static final String MESSAGE_JAVAFX_MIXIN_CANNOT_BE_INSTANTIATED = "visage.mixin.cant.be.instantiated";
    public static final String MESSAGE_JAVAFX_FOR_OVER_ITERABLE_DISALLOWED_IN_BIND = "visage.for.over.iterable.disallowed.in.bind";
    public static final String MESSAGE_JAVAFX_KEYVALUE_REQUIRED = "visage.keyvalue.required";
    public static final String MESSAGE_JAVAFX_MANDATORY_COMMA = "visage.mandatory.comma";
    public static final String MESSAGE_JAVAFX_TYPES_INCOMPATIBLE_VARS = "visage.types.incompatible.vars";
    public static final String MESSAGE_JAVAFX_WARN_ON_USE_PACKAGE = "visage.warn.on.use.package";
    public static final String MESSAGE_JAVAFX_MULTIPLE_DEFAULT_VARS = "visage.multiple.default.vars";
    public static final String MESSAGE_JAVAFX_NO_DEFAULT_DECLARED = "visage.no.default.declared";
}
