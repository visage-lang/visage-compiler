...
public class JavafxEnter extends JavafxTreeScanner {
    protected static final Context.Key<JavafxEnter> visageEnterKey =
    ...
    private JavafxScriptClassBuilder visageModuleBuilder;
    
    public static JavafxEnter instance(Context context) {
        JavafxEnter instance = context.get(visageEnterKey);
        if (instance == null) {
    ...
    protected JavafxEnter(Context context) {
        ...
        visageModuleBuilder = JavafxScriptClassBuilder.instance(context);
