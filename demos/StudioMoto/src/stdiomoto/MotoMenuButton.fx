...
attribute MotoMenuButton.a = KeyFrameAnimation {
    toggle: true
    keyFrames:
    [at (0s) {
        y => 0;
...
function MotoMenuButton.composeNode() =
Group {
    content:
    [Group {
        cursor: HAND
        ...
        Group {
            ...
            ImageView {
                ...
                //var i = bind if false and mouseOver then (11 + u * 55).intValue() else 7
                //image: {url: bind "{__DIR__}/Image/{i}.png"}
                image: {url: "{__DIR__}/Image/7.png"}
            },
            ImageView {
