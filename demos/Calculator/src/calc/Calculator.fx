...
public class Calculator extends CompositeNode {
    //TODO images are actually in the jar file, so you don't need directory reference any more
    static attribute pwd:java.io.File = new java.io.File(".");
    static attribute __DIR__:String = pwd.toURI().toString();
    ...
    function input(value:String):Void {
        ...
        } else if (value == "0" or value == "1" or value == "3" or
    ...
    public function composeNode(): Node {
        ...
        Group {
            ...
            (CalcButton {
                ...
                image: Image{url: "{__DIR__}/images/{dec[i]}.png"}
                pressedImage: Image{url: "{__DIR__}/images/d{dec[i]}.png"}
            ...
            (CalcButton {
                ...
                image: Image{url: "{__DIR__}/images/{mr[i]}.png"}
                pressedImage: Image{url: "{__DIR__}/images/d{mr[i]}.png"}
            ...
            (CalcButton {
                ...
                image: Image{url: bind "{__DIR__}/images/{if (operator == ops[i]) then 'a{divmult[i]}' else divmult[i]}.png"}
                pressedImage: Image{url: "{__DIR__}/images/d{divmult[i]}.png"}
                action: function():Void {input(ops[i]);}
            }as Object) as Node,
            (CalcButton {
                transform: [Transform.translate(131, 170)]
                image: Image{url: "{__DIR__}/images/equal.png"}
                pressedImage: Image{url: "{__DIR__}/images/dequal.png"}
