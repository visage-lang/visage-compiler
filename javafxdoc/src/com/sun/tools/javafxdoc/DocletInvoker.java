...
public class DocletInvoker {
    ...
    public boolean start(RootDoc root) {
        ...
        if (retVal instanceof Boolean) {
            ...
            messager.error("main.must_return_boolean",
    ...
    public int optionLength(String option) {
        ...
        if (retVal instanceof Integer) {
            ...
            messager.error("main.must_return_int",
                           docletClassName, methodName);
            return -1;
        }
    }
    ...
    public LanguageVersion languageVersion() {
        try {
            ...
            if (retVal instanceof LanguageVersion) {
                ...
                messager.error("main.must_return_languageversion",
                               docletClassName, methodName);
                return JAVA_1_1;
            }
        ...
        throws DocletInvokeException {
            ...
            try {
                ...
                if (returnValueIfNonExistent == null) {
                    messager.error("main.doclet_method_not_found",
                                   docletClassName, methodName);
                ...
                messager.error("main.doclet_method_not_accessible",
                               docletClassName, methodName);
                throw new DocletInvokeException();
            }
            if (!Modifier.isStatic(meth.getModifiers())) {
                messager.error("main.doclet_method_must_be_static",
                               docletClassName, methodName);
                throw new DocletInvokeException();
            }
            try {
                ...
                messager.error("main.internal_error_exception_thrown",
                ...
                messager.error("main.exception_thrown",
                               docletClassName, methodName, exc.toString());
