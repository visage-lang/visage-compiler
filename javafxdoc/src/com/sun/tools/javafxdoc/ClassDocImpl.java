...
public class ClassDocImpl extends ProgramElementDocImpl implements ClassDoc {
    ...
    public MethodDoc[] methods(boolean filter) {
        ...
        List<FunctionDocImpl> methods = List.nil();
        for (Scope.Entry e = tsym.members().elems; e != null; e = e.sibling) {
            if (e.sym != null &&
        ...
        //### Cache methods here?
        return methods.toArray(new FunctionDocImpl[methods.length()]);
    }
     ...
     */
    public FunctionDocImpl findMethod(String methodName, String[] paramTypes) {
    ...
    private FunctionDocImpl searchMethod(String methodName,
