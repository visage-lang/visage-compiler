...
import com.sun.javafx.jdi.connect.FXSharedMemoryAttachingConnector;
import com.sun.javafx.jdi.connect.FXSharedMemoryListeningConnector;
import com.sun.javafx.jdi.connect.FXSocketAttachingConnector;
import com.sun.javafx.jdi.connect.FXSocketListeningConnector;
...
public class ConnectorsTest {
    ...
    public void testFXConnectors() {
        ...
        Assert.assertEquals("com.sun.javafx.jdi.connect.FXProcessAttachingConnector", conn2.name());
        Assert.assertEquals(true, conn2 instanceof AttachingConnector);

        FXRawLaunchingConnector conn3 = new FXRawLaunchingConnector();
        Assert.assertEquals("com.sun.javafx.jdi.connect.FXRawLaunchingConnector", conn3.name());
        ...
        Assert.assertEquals("com.sun.javafx.jdi.connect.FXSocketAttachingConnector", conn4.name());
        ...
        Assert.assertEquals("com.sun.javafx.jdi.connect.FXSocketListeningConnector", conn5.name());
        ...
        if (FXSharedMemoryAttachingConnector.isAvailable()) {
            ...
            Assert.assertEquals("com.sun.javafx.jdi.connect.FXSharedMemoryAttachingConnector", conn6.name());
        ...
        if (FXSharedMemoryListeningConnector.isAvailable()) {
            ...
            Assert.assertEquals("com.sun.javafx.jdi.connect.FXSharedMemoryListeningConnector", conn7.name());
