...
public class InvokeExceptionsTest extends JavafxTestBase {
    ...
    private static final String targetClassName = "com.sun.javafx.jdi.test.target.InvokeExceptionsTarget";
    ...
    protected void runTests() throws Exception {
        writeActual("stop in = " + "javafx.lang.Builtins.println");


        BreakpointEvent bpe = startTo("javafx.lang.Builtins", "println", "(Ljava/lang/Object;)V");
