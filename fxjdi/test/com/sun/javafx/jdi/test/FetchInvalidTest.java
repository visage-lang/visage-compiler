...
public class FetchInvalidTest extends JavafxTestBase {
    ReferenceType targetClass;
    ThreadReference mainThread;

    private static final String targetClassName = "com.sun.javafx.jdi.test.target.FetchInvalidTarget";

    public FetchInvalidTest() {
