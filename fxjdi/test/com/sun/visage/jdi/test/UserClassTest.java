...
public class UserClassTest extends VisageTestBase {
    ReferenceType targetClass;
    ThreadReference mainThread;

    private static final String targetClassName = "org.visage.jdi.test.target.UserClassTarget";
    ...
    protected void runTests() throws Exception {
        startToMain();
        BreakpointEvent bpe = resumeTo("visage.lang.Builtins", "println", "(Ljava/lang/Object;)V");
        ...
        bpe = resumeTo("visage.lang.Builtins", "println", "(Ljava/lang/Object;)V");
