 ...
 * @author sundar
 */
public abstract class VisageTestBase extends TestScaffold {
    ...
    protected static String visagertJarPath() {
    ...
    protected VisageTestBase(String targetClassName) {
    ...
    protected VisageTestBase(String[] args) {
        super(args);
    }
