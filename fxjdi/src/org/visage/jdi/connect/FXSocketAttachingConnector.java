 ...
 * @author sundar
 */
public class VisageSocketAttachingConnector extends VisageConnector implements AttachingConnector {
    public VisageSocketAttachingConnector() {
        this(makePlatformConnector());
    }

    public VisageSocketAttachingConnector(AttachingConnector underlying) {
        super(underlying);
    }
