 ...
 * @author sundar
 */
public class FXExceptionRequest extends FXEventRequest implements ExceptionRequest {
    public FXExceptionRequest(FXVirtualMachine fxvm, ExceptionRequest underlying) {
    ...
    public boolean notifyCaught() {
        return underlying().notifyCaught();
    }

    public boolean notifyUncaught() {
        return underlying().notifyUncaught();
    }

    @Override
    protected ExceptionRequest underlying() {
        return (ExceptionRequest) super.underlying();
    }
}
