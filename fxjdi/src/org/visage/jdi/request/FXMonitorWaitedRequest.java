 ...
 * @author sundar
 */
public class FXMonitorWaitedRequest extends FXEventRequest implements MonitorWaitedRequest {
    public FXMonitorWaitedRequest(FXVirtualMachine fxvm, MonitorWaitedRequest underlying) {
