 ...
 * @author sundar
 */
public class FXThreadStartEvent extends FXEvent implements ThreadStartEvent {
    public FXThreadStartEvent(FXVirtualMachine fxvm, ThreadStartEvent underlying) {
